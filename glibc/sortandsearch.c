...
int comparison(const void *a, const void *b) { return (int)(*(int *)a - *(int *)b); }
...
int main(int argc, char **args) {
    ...
    /*If there are multiple elements that match the key, the element returned is
     * unspecified*/
    /*Note that, compared elements could be anything like a struct. All needed is
     * to pass suitable key to the comprarator function*/
