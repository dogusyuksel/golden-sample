...
variable’s state has changed. The wait operation is the means of blocking until
such a notification is received. They are used with mutexes
...
continually polling (possibly in a critical section), to check if the condition
is met.
