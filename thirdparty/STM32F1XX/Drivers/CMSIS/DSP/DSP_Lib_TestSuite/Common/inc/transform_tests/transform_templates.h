...
#define TRANSFORM_SNR_COMPARE_INTERFACE(block_size, output_type)                                                       \
    do {                                                                                                               \
        TEST_CONVERT_AND_ASSERT_SNR(transform_fft_output_f32_ref, (output_type *)transform_fft_output_ref,             \
                                    transform_fft_output_f32_fut, (output_type *)transform_fft_output_fut, block_size, \
                                    output_type, TRANSFORM_SNR_THRESHOLD_##output_type);                               \
    } while (0)
...
#define DCT_TRANSFORM_SNR_COMPARE_INTERFACE(block_size, output_type)                                                   \
    do {                                                                                                               \
        TEST_CONVERT_AND_ASSERT_SNR(transform_fft_output_f32_ref, (output_type *)transform_fft_output_ref,             \
                                    transform_fft_output_f32_fut, (output_type *)transform_fft_output_fut, block_size, \
                                    output_type, DCT4_TRANSFORM_SNR_THRESHOLD_##output_type);                          \
    } while (0)
