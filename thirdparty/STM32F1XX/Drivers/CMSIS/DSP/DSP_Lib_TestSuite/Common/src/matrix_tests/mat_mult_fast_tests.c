...
#define JTEST_ARM_MAT_MULT_FAST_TEST(suffix)                                                                           \
    MATRIX_DEFINE_TEST_TEMPLATE_ELT2(mat_mult_fast, suffix, MATRIX_TEST_CONFIG_MULTIPLICATIVE_OUTPUT,                  \
...
JTEST_DEFINE_TEST(arm_mat_mult_fast_q15_test, arm_mat_mult_fast_q15) {
    MATRIX_TEST_TEMPLATE_ELT2(matrix_q15_a_inputs, matrix_q15_b_inputs, arm_matrix_instance_q15 *,
                              ...
                              REF_mat_mult_fast_INPUT_INTERFACE, MATRIX_TEST_CONFIG_MULTIPLICATIVE_OUTPUT,
                              MATRIX_TEST_VALID_MULTIPLICATIVE_DIMENSIONS, MATRIX_SNR_COMPARE_INTERFACE);
}
