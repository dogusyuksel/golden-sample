...
#define JTEST_ARM_X_TO_Y_TEST(prefix, suffix)                                                                          \
    JTEST_DEFINE_TEST(arm_##prefix##_to_##suffix##_test, arm_##prefix##_to_##suffix) {                                 \
        TEST_TEMPLATE_BUF1_BLK(support_f_all, support_block_sizes, TYPE_FROM_ABBREV(prefix), TYPE_FROM_ABBREV(suffix), \
                               arm_##prefix##_to_##suffix, ARM_x_to_y_INPUT_INTERFACE, ref_##prefix##_to_##suffix,     \
