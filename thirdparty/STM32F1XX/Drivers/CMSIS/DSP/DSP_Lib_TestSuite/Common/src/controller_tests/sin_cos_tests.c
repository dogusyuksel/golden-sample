...
ARR_DESC_DEFINE(float32_t, arm_sin_cos_degrees_f32, 9, CURLY(0, 17, 45, 90, 180, 360, 362, -73, -191.111));
...
JTEST_DEFINE_TEST(arm_sin_cos_f32_test, arm_sin_cos_f32) {
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        JTEST_COUNT_CYCLES(
            arm_sin_cos_f32(degree, (TYPE_FROM_ABBREV(f32) *)&sin_val_fut, (TYPE_FROM_ABBREV(f32) *)&cos_val_fut));
        ref_sin_cos_f32(degree, (TYPE_FROM_ABBREV(f32) *)&sin_val_ref, (TYPE_FROM_ABBREV(f32) *)&cos_val_ref);
...
JTEST_DEFINE_TEST(arm_sin_cos_q31_test, arm_sin_cos_q31) {
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        /* Display cycle count and run test */
        JTEST_COUNT_CYCLES(
            arm_sin_cos_q31(degree, (TYPE_FROM_ABBREV(q31) *)&sin_val_fut, (TYPE_FROM_ABBREV(q31) *)&cos_val_fut));
        ref_sin_cos_q31(degree, (TYPE_FROM_ABBREV(q31) *)&sin_val_ref, (TYPE_FROM_ABBREV(q31) *)&cos_val_ref);
