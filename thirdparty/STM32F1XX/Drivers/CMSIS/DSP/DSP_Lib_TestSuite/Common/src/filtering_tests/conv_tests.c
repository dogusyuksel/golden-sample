...
#define CONV_TEST_VALID_PARTIAL_PARAMS(input_a_len, input_b_len, first_index, num_points)                              \
    (((((input_a_len) + (input_b_len)-1)) >= num_points + first_index) && (num_points > 0))
...
#define CONV_arm_conv_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                                  \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, (void *)filtering_scratch,         \
          (void *)filtering_scratch2)

#define CONV_ref_conv_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                                  \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, (void *)filtering_scratch,         \
          (void *)filtering_scratch2)

#define CONV_arm_conv_fast_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                                 \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut)

#define CONV_ref_conv_fast_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                                 \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref)

#define CONV_arm_conv_fast_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                             \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, (void *)filtering_scratch,         \
          (void *)filtering_scratch2)

#define CONV_ref_conv_fast_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len)                             \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, (void *)filtering_scratch,         \
          (void *)filtering_scratch2)

#define CONV_arm_conv_partial_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index, num_points)     \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, first_index, num_points)

#define CONV_ref_conv_partial_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index, num_points)     \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, first_index, num_points)

#define CONV_arm_conv_partial_fast_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index,            \
                                                   num_points)                                                         \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, first_index, num_points)

#define CONV_ref_conv_partial_fast_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index,            \
                                                   num_points)                                                         \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, first_index, num_points)

#define CONV_arm_conv_partial_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index, num_points) \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, first_index, num_points,           \
          (void *)filtering_scratch, (void *)filtering_scratch2)

#define CONV_ref_conv_partial_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index, num_points) \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, first_index, num_points,           \
          (void *)filtering_scratch, (void *)filtering_scratch2)

#define CONV_arm_conv_partial_fast_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index,        \
                                                       num_points)                                                     \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_fut, first_index, num_points,           \
          (void *)filtering_scratch, (void *)filtering_scratch2)

#define CONV_ref_conv_partial_fast_opt_INPUT_INTERFACE(input_a, input_a_len, input_b, input_b_len, first_index,        \
                                                       num_points)                                                     \
    PAREN(input_a, input_a_len, input_b, input_b_len, (void *)filtering_output_ref, first_index, num_points,           \
          (void *)filtering_scratch, (void *)filtering_scratch2)
...
#define CONV_DEFINE_RAND_INPUT_ARR_DESCS(type_suffix)                                                                  \
    ARR_DESC_DEFINE_USING_ARR(TYPE_FROM_ABBREV(type_suffix), conv_input_rand1_##type_suffix,                           \
                              CONV_##type_suffix##_INPUTS, 0, CONV_MAX_INPUT_ELTS);                                    \
                                                                                                                       \
    ARR_DESC_DEFINE_USING_ARR(TYPE_FROM_ABBREV(type_suffix), conv_input_rand2_##type_suffix,                           \
                              CONV_##type_suffix##_INPUTS, 1, CONV_MAX_INPUT_ELTS) /* Note the lacking semicolon */
...
#define CONV_DEFINE_ALL_INPUTS(type_suffix)                                                                            \
    ARR_DESC_DEFINE(ARR_DESC_t *, conv_##type_suffix##_a_inputs, 4,                                                    \
                    CURLY(&conv_input_zeros, &conv_input_zeros, &conv_input_rand1_##type_suffix,                       \
                          &conv_input_rand1_##type_suffix));                                                           \
    ARR_DESC_DEFINE(ARR_DESC_t *, conv_##type_suffix##_b_inputs, 4,                                                    \
                    CURLY(&conv_input_zeros, &conv_input_rand1_##type_suffix, &conv_input_zeros,                       \
 ...
 */
ARR_DESC_DEFINE(uint32_t, conv_lens_a, 5, CURLY(1, 1, 17, 15, CONV_MAX_INPUT_ELTS));

ARR_DESC_DEFINE(uint32_t, conv_lens_b, 5, CURLY(1, 2, 1, CONV_MAX_INPUT_ELTS, CONV_MAX_INPUT_ELTS));

/*--------------------------------------------------------------------------------*/
/* Partial Indexing */
/*--------------------------------------------------------------------------------*/

ARR_DESC_DEFINE(uint32_t, first_index_arr_desc, 4, CURLY(0, 1, CONV_MAX_INPUT_ELTS / 2, CONV_MAX_INPUT_ELTS));

ARR_DESC_DEFINE(uint32_t, num_points_arr_desc, 3, CURLY(1, CONV_MAX_OUTPUT_ELTS / 2, CONV_MAX_OUTPUT_ELTS));

/*--------------------------------------------------------------------------------*/
/* Convolution Tests */
/*--------------------------------------------------------------------------------*/

#define CONV_TEST_TEMPLATE(fut, fut_arg_interface, ref, ref_arg_interface, suffix, output_type)                        \
    JTEST_DEFINE_TEST(fut##_tests, fut) {                                                                              \
        TEMPLATE_DO_ARR_DESC(                                                                                          \
            input_idx, ARR_DESC_t *, input_ptr, conv_##suffix##_a_inputs, void *input_a_ptr = input_ptr->data_ptr;     \
            void *input_b_ptr = ARR_DESC_ELT(ARR_DESC_t *, input_idx, &(conv_##suffix##_b_inputs))->data_ptr;          \
                                                                                                                       \
            TEMPLATE_DO_ARR_DESC(                                                                                      \
                conv_len_idx, uint32_t, conv_len_a, conv_lens_a,                                                       \
                uint32_t conv_len_b = ARR_DESC_ELT(uint32_t, conv_len_idx, &(conv_lens_b));                            \
                                                                                                                       \
                JTEST_DUMP_STRF("Input A Length: %d\n"                                                                 \
                                "Input B Length: %d\n",                                                                \
                                (int)conv_len_a, (int)conv_len_b);                                                     \
                                                                                                                       \
                TEST_CALL_FUT_AND_REF(fut, fut_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b), ref,   \
                                      ref_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b));            \
                                                                                                                       \
                FILTERING_SNR_COMPARE_INTERFACE(conv_len_a + conv_len_b - 1, output_type)));                           \
                                                                                                                       \
        return JTEST_TEST_PASSED;                                                                                      \
    }

#define CONV_PARTIAL_TEST_TEMPLATE(fut, fut_arg_interface, ref, ref_arg_interface, suffix, output_type)                \
    JTEST_DEFINE_TEST(fut##_tests, fut) {                                                                              \
        TEMPLATE_DO_ARR_DESC(                                                                                          \
            input_idx, ARR_DESC_t *, input_ptr, conv_##suffix##_a_inputs, void *input_a_ptr = input_ptr->data_ptr;     \
            void *input_b_ptr = ARR_DESC_ELT(ARR_DESC_t *, input_idx, &(conv_##suffix##_b_inputs))->data_ptr;          \
            TEMPLATE_DO_ARR_DESC(                                                                                      \
                ...
                TEMPLATE_DO_ARR_DESC(                                                                                  \
                    ...
                    TEMPLATE_DO_ARR_DESC(                                                                              \
                        ...
                        if (CONV_TEST_VALID_PARTIAL_PARAMS(conv_len_a, conv_len_b, first_index, num_points)) {         \
                            /* Display test parameter values */                                                        \
                            JTEST_DUMP_STRF("Input A Length: %d\n"                                                     \
                                            "Input B Length: %d\n"                                                     \
                                            "First Sample Index: %d\n"                                                 \
                                            "Number of Output Points: %d\n",                                           \
                                            (int)conv_len_a, (int)conv_len_b, (int)first_index, (int)num_points);      \
                                                                                                                       \
                            memset(filtering_output_ref, 0, (2 * CONV_MAX_INPUT_ELTS) * sizeof(output_type));          \
                            memset(filtering_output_fut, 0, (2 * CONV_MAX_INPUT_ELTS) * sizeof(output_type));          \
                                                                                                                       \
                            TEST_CALL_FUT_AND_REF(fut,                                                                 \
                                                  fut_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b,  \
                                                                    first_index, num_points),                          \
                                                  ref,                                                                 \
                                                  ref_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b,  \
                                                                    first_index, num_points));                         \
                                                                                                                       \
                            FILTERING_SNR_COMPARE_INTERFACE_OFFSET(first_index, num_points, output_type);              \
                        } else {                                                                                       \
...
#define CONV_DEFINE_TEST(fn_name, suffix, output_type, test_template)                                                  \
    test_template(arm_##fn_name##_##suffix, CONV_arm_##fn_name##_INPUT_INTERFACE, ref_##fn_name##_##suffix,            \
                  CONV_ref_##fn_name##_INPUT_INTERFACE, suffix, output_type) /* Note the lacking semicolon*/
