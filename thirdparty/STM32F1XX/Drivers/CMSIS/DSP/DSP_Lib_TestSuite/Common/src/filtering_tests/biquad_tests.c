...
#define BIQUAD_DEFINE_TEST(suffix, instance_name, config_suffix, output_type)                                          \
    JTEST_DEFINE_TEST(arm_biquad_cascade_##config_suffix##_##suffix##_test,                                            \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                          \
            ...
            TEMPLATE_DO_ARR_DESC(                                                                                      \
                numstages_idx, uint16_t, numStages, filtering_numstages, /* Initialize the BIQUAD Instances */         \
                arm_biquad_cascade_##config_suffix##_init_##suffix(&biquad_inst_fut, numStages,                        \
                ...
                JTEST_COUNT_CYCLES(arm_biquad_cascade_##config_suffix##_##suffix(                                      \
                    &biquad_inst_fut, (void *)filtering_##suffix##_inputs, (void *)filtering_output_fut, blockSize));  \
                                                                                                                       \
                arm_biquad_cascade_##config_suffix##_init_##suffix(&biquad_inst_ref, numStages,                        \
                                                                   (output_type *)filtering_coeffs_b_##suffix,         \
                                                                   (void *)filtering_pState);                          \
                                                                                                                       \
                ref_biquad_cascade_##config_suffix##_##suffix(&biquad_inst_ref, (void *)filtering_##suffix##_inputs,   \
    ...
    JTEST_DEFINE_TEST(arm_biquad_cascade_##config_suffix##speed##_##suffix##_test,                                     \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                          \
            ...
            TEMPLATE_DO_ARR_DESC(                                                                                      \
                ...
                TEMPLATE_DO_ARR_DESC(                                                                                  \
                    postshifts_idx, uint8_t, postShift, filtering_postshifts, /* Display test parameter values */      \
                    JTEST_DUMP_STRF("Block Size: %d\n"                                                                 \
                                    "Number of Stages: %d\n"                                                           \
                                    "Post Shift: %d\n",                                                                \
                                    (int)blockSize, (int)numStages, (int)postShift);                                   \
                                                                                                                       \
                    ...
                    arm_biquad_cascade_##config_suffix##_init_##suffix(&biquad_inst_fut, numStages,                    \
                                                                       ...
                                                                       (void *)filtering_pState, postShift);           \
                                                                                                                       \
                    JTEST_COUNT_CYCLES(arm_biquad_cascade_##config_suffix##speed##_##suffix(                           \
                        &biquad_inst_fut, (void *)filtering_##suffix##_inputs, (void *)filtering_output_fut,           \
                        blockSize));                                                                                   \
                                                                                                                       \
                    arm_biquad_cascade_##config_suffix##_init_##suffix(&biquad_inst_ref, numStages,                    \
                                                                       (output_type *)filtering_coeffs_b_##suffix,     \
                                                                       (void *)filtering_pState, postShift);           \
                                                                                                                       \
                    ref_biquad_cascade_##config_suffix##speed##_##suffix(&biquad_inst_ref,                             \
...
JTEST_DEFINE_TEST(arm_biquad_cas_df1_32x64_q31_test, arm_biquad_cas_df1_32x64_q31) {
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        TEMPLATE_DO_ARR_DESC(
            ...
            TEMPLATE_DO_ARR_DESC(
                ...
                /* Initialize the BIQUAD Instances */
                arm_biquad_cas_df1_32x64_init_q31(&biquad_inst_fut, numStages, (q31_t *)filtering_coeffs_b_q31,
                                                  (void *)filtering_pState, postShift);
                ...
                JTEST_COUNT_CYCLES(arm_biquad_cas_df1_32x64_q31(&biquad_inst_fut, (void *)filtering_q31_inputs,
                                                                (void *)filtering_output_fut, blockSize));

                arm_biquad_cas_df1_32x64_init_q31(&biquad_inst_ref, numStages, (q31_t *)filtering_coeffs_b_q31,
                                                  (void *)filtering_pState, postShift);

                ref_biquad_cas_df1_32x64_q31(&biquad_inst_ref, (void *)filtering_q31_inputs,
                                             (void *)filtering_output_ref, blockSize);
...
JTEST_DEFINE_TEST(arm_biquad_cascade_df2T_f64_test, arm_biquad_cascade_df2T_f64) {
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        TEMPLATE_DO_ARR_DESC(
            ...
            /* Initialize the BIQUAD Instances */
            arm_biquad_cascade_df2T_init_f64(&biquad_inst_fut, numStages, (float64_t *)filtering_coeffs_b_f64,
                                             (void *)filtering_pState);

            JTEST_COUNT_CYCLES(arm_biquad_cascade_df2T_f64(&biquad_inst_fut, (void *)filtering_f64_inputs,
                                                           (void *)filtering_output_fut, blockSize));

            arm_biquad_cascade_df2T_init_f64(&biquad_inst_ref, numStages, (float64_t *)filtering_coeffs_b_f64,
                                             (void *)filtering_pState);

            ref_biquad_cascade_df2T_f64(&biquad_inst_ref, (void *)filtering_f64_inputs, (void *)filtering_output_ref,
                                        blockSize);
