...
q31_t ref__QADD8(q31_t x, q31_t y) {
    ...
    sum = (((q31_t)u << 24) & 0xFF000000) | (((q31_t)t << 16) & 0x00FF0000) | (((q31_t)s << 8) & 0x0000FF00) |
          (r & 0x000000FF);
...
q31_t ref__QASX(q31_t x, q31_t y) {
    ...
    sum = (((q31_t)ref_sat_q15(xH + yL)) << 16) | (((q31_t)ref_sat_q15(xL - yH)) & 0xffff);
...
q31_t ref__SMUSDX(q31_t x, q31_t y) { return ((q31_t)(((q15_t)x * (q15_t)(y >> 16)) - ((q15_t)(x >> 16) * (q15_t)y))); }

q31_t ref__SMUADX(q31_t x, q31_t y) { return ((q31_t)(((q15_t)x * (q15_t)(y >> 16)) + ((q15_t)(x >> 16) * (q15_t)y))); }

q31_t ref__QADD(q31_t x, q31_t y) { return ref_sat_q31((q63_t)x + y); }

q31_t ref__QSUB(q31_t x, q31_t y) { return ref_sat_q31((q63_t)x - y); }
...
q31_t ref__SMUAD(q31_t x, q31_t y) { return (((x >> 16) * (y >> 16)) + (((x << 16) >> 16) * ((y << 16) >> 16))); }

q31_t ref__SMUSD(q31_t x, q31_t y) { return (-((x >> 16) * (y >> 16)) + (((x << 16) >> 16) * ((y << 16) >> 16))); }

q31_t ref__SXTB16(q31_t x) { return ((((x << 24) >> 24) & 0x0000FFFF) | (((x << 8) >> 8) & 0xFFFF0000)); }
