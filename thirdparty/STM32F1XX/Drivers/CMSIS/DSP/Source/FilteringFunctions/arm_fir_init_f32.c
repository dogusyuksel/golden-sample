 ...
 * <code>pState</code> is of length <code>numTaps+blockSize-1</code> samples, where <code>blockSize</code> is the number
 * of input samples processed by each call to <code>arm_fir_f32()</code>.
 */
