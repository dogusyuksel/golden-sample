 ...
 * \par Description:
 * \par
 * The parameter <code>fftLen</code>	Specifies length of RFFT/CIFFT process. Supported FFT Lengths are 32, 64, 128,
 * 256, 512, 1024, 2048, 4096. \par This Function also initializes Twiddle factor table pointer and Bit reversal table
 * pointer.
 */
