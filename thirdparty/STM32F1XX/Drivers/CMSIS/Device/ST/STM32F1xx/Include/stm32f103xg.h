...
#define AFIO_MAPR_ADC1_ETRGINJ_REMAP                                                                                   \
    AFIO_MAPR_ADC1_ETRGINJ_REMAP_Msk /*!< ADC 1 External Trigger Injected Conversion remapping */
...
#define AFIO_MAPR_ADC1_ETRGREG_REMAP                                                                                   \
    AFIO_MAPR_ADC1_ETRGREG_REMAP_Msk /*!< ADC 1 External Trigger Regular Conversion remapping */
...
#define AFIO_MAPR_ADC2_ETRGINJ_REMAP                                                                                   \
    AFIO_MAPR_ADC2_ETRGINJ_REMAP_Msk /*!< ADC 2 External Trigger Injected Conversion remapping */
...
#define AFIO_MAPR_ADC2_ETRGREG_REMAP                                                                                   \
    AFIO_MAPR_ADC2_ETRGREG_REMAP_Msk /*!< ADC 2 External Trigger Regular Conversion remapping */
...
#define AFIO_MAPR2_TIM9_REMAP_Msk (0x1UL << AFIO_MAPR2_TIM9_REMAP_Pos) /*!< 0x00000020 */
#define AFIO_MAPR2_TIM9_REMAP AFIO_MAPR2_TIM9_REMAP_Msk                /*!< TIM9 remapping */
#define AFIO_MAPR2_TIM10_REMAP_Pos (6U)
#define AFIO_MAPR2_TIM10_REMAP_Msk (0x1UL << AFIO_MAPR2_TIM10_REMAP_Pos) /*!< 0x00000040 */
#define AFIO_MAPR2_TIM10_REMAP AFIO_MAPR2_TIM10_REMAP_Msk                /*!< TIM10 remapping */
#define AFIO_MAPR2_TIM11_REMAP_Pos (7U)
#define AFIO_MAPR2_TIM11_REMAP_Msk (0x1UL << AFIO_MAPR2_TIM11_REMAP_Pos) /*!< 0x00000080 */
...
#define SDIO_STA_TXFIFOHE                                                                                              \
    SDIO_STA_TXFIFOHE_Msk /*!< Transmit FIFO Half Empty: at least 8 words can be written into the FIFO */
...
#define SDIO_FIFOCNT_FIFOCOUNT                                                                                         \
    SDIO_FIFOCNT_FIFOCOUNT_Msk /*!< Remaining number of words to be written to or read from the FIFO */
...
#define IS_ADC_DMA_CAPABILITY_INSTANCE(INSTANCE) (((INSTANCE) == ADC1) || ((INSTANCE) == ADC3))
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                                      \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) ||                   \
     ((INSTANCE) == TIM4) || ((INSTANCE) == TIM5) || ((INSTANCE) == TIM6) || ((INSTANCE) == TIM7) ||                   \
     ((INSTANCE) == TIM9) || ((INSTANCE) == TIM10) || ((INSTANCE) == TIM11) || ((INSTANCE) == TIM12) ||                \
...
#define IS_TIM_CC1_INSTANCE(INSTANCE)                                                                                  \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) ||                   \
     ((INSTANCE) == TIM4) || ((INSTANCE) == TIM5) || ((INSTANCE) == TIM9) || ((INSTANCE) == TIM10) ||                  \
     ((INSTANCE) == TIM11) || ((INSTANCE) == TIM12) || ((INSTANCE) == TIM13) || ((INSTANCE) == TIM14))

#define IS_TIM_CC2_INSTANCE(INSTANCE)                                                                                  \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) ||                   \
     ((INSTANCE) == TIM4) || ((INSTANCE) == TIM5) || ((INSTANCE) == TIM9) || ((INSTANCE) == TIM12))
