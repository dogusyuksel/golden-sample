...
#if ((defined(__ARM_ARCH_8M_MAIN__) && (__ARM_ARCH_8M_MAIN__ != 0)) || (defined(__CORTEX_M) && (__CORTEX_M == 7U)))
...
#elif ((defined(__ARM_ARCH_7M__) && (__ARM_ARCH_7M__ != 0)) || (defined(__ARM_ARCH_7EM__) && (__ARM_ARCH_7EM__ != 0)))
...
__WEAK uint32_t OS_Tick_GetOverflow(void) { return ((SysTick->CTRL >> 16) & 1U); }
