...
#define __CM1_CMSIS_VERSION                                                                                            \
    ((__CM1_CMSIS_VERSION_MAIN << 16U) | __CM1_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS HAL version number */
...
#define SCnSCB_ACTLR_ITCMUAEN_Msk                                                                                      \
    (1UL << SCnSCB_ACTLR_ITCMUAEN_Pos) /*!< ACTLR: Instruction TCM Upper Alias Enable Mask */

#define SCnSCB_ACTLR_ITCMLAEN_Pos 3U /*!< ACTLR: Instruction TCM Lower Alias Enable Position */
#define SCnSCB_ACTLR_ITCMLAEN_Msk                                                                                      \
    (1UL << SCnSCB_ACTLR_ITCMLAEN_Pos) /*!< ACTLR: Instruction TCM Lower Alias Enable Mask */
...
/**
  ...
  \brief    Cortex-M1 Core Debug Registers (DCB registers, SHCSR, and DFSR) are only accessible over DAP and not via
  processor. Therefore they are not covered by the Cortex-M1 header file.
  @{
 */
