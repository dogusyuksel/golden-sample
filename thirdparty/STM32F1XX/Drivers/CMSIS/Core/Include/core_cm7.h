...
#define __CM7_CMSIS_VERSION                                                                                            \
    ((__CM7_CMSIS_VERSION_MAIN << 16U) | __CM7_CMSIS_VERSION_SUB) /*!< \deprecated CMSIS HAL version number */
...
__STATIC_INLINE void SCB_CleanDCache(void) {
    ...
    do {
        ...
        do {
            SCB->DCCSW =
                (((sets << SCB_DCCSW_SET_Pos) & SCB_DCCSW_SET_Msk) | ((ways << SCB_DCCSW_WAY_Pos) & SCB_DCCSW_WAY_Msk));
#if defined(__CC_ARM)
            __schedule_barrier();
#endif
        } while (ways-- != 0U);
