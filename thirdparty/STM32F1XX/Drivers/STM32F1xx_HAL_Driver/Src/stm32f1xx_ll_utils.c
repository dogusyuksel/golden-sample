...
#define IS_LL_UTILS_PLL2MUL_VALUE(__VALUE__)                                                                           \
    (((__VALUE__) == LL_RCC_PLL2_MUL_8) || ((__VALUE__) == LL_RCC_PLL2_MUL_9) ||                                       \
     ((__VALUE__) == LL_RCC_PLL2_MUL_10) || ((__VALUE__) == LL_RCC_PLL2_MUL_11) ||                                     \
     ((__VALUE__) == LL_RCC_PLL2_MUL_12) || ((__VALUE__) == LL_RCC_PLL2_MUL_13) ||                                     \
     ((__VALUE__) == LL_RCC_PLL2_MUL_14) || ((__VALUE__) == LL_RCC_PLL2_MUL_16) ||                                     \
...
#if defined(RCC_CFGR2_PREDIV1)
    pllfreq =
        __LL_RCC_CALC_PLLCLK_FREQ(PLL_InputFrequency / (UTILS_PLLInitStruct->Prediv + 1U), UTILS_PLLInitStruct->PLLMul);
#else
    pllfreq =
        __LL_RCC_CALC_PLLCLK_FREQ(PLL_InputFrequency / ((UTILS_PLLInitStruct->Prediv >> RCC_CFGR_PLLXTPRE_Pos) + 1U),
...
static uint32_t UTILS_GetPLL2OutputFrequency(uint32_t PLL2_InputFrequency,
    ...
    pll2freq =
        __LL_RCC_CALC_PLL2CLK_FREQ(PLL2_InputFrequency, UTILS_PLL2InitStruct->PLLMul, UTILS_PLL2InitStruct->Prediv);
