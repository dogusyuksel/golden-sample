...
#define CEC_ESR_ALL_ERROR                                                                                              \
    (CEC_ESR_BTE | CEC_ESR_BPE | CEC_ESR_RBTFE | CEC_ESR_SBE | CEC_ESR_ACKE | CEC_ESR_LINE | CEC_ESR_TBTFE)
 ...
 * @retval Frame size
 */
uint32_t HAL_CEC_GetLastReceivedFrameSize(const CEC_HandleTypeDef *hcec) { return hcec->RxXferSize; }
 ...
 * @retval Frame size
 */
void HAL_CEC_ChangeRxBuffer(CEC_HandleTypeDef *hcec, uint8_t *Rxbuffer) { hcec->Init.RxBuffer = Rxbuffer; }
 ...
 */
uint32_t HAL_CEC_GetError(const CEC_HandleTypeDef *hcec) { return hcec->ErrorCode; }
