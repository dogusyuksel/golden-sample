...
HAL_StatusTypeDef HAL_SPI_DMAStop(SPI_HandleTypeDef *hspi) {
    ...
    /* The Lock is not implemented on this API to allow the user application
       ...
       HAL_SPI_TxRxCpltCallback(): when calling HAL_DMA_Abort() API the DMA TX/RX Transfer complete interrupt is
       generated and the correspond call back is executed HAL_SPI_TxCpltCallback() or HAL_SPI_RxCpltCallback() or
...
static void SPI_DMATransmitCplt(DMA_HandleTypeDef *hdma) {
    SPI_HandleTypeDef *hspi =
        (SPI_HandleTypeDef *)(((DMA_HandleTypeDef *)hdma)->Parent); /* Derogation MISRAC2012-Rule-11.5 */
    uint32_t tickstart;
...
uint8_t SPI_ISCRCErrorValid(SPI_HandleTypeDef *hspi) {
    ...
    /* If CRC errors could be wrongly detected (issue 2.15.2 in STM32F10xxC/D/E silicon limitations ES (DocID14732 Rev
     * 13) */
