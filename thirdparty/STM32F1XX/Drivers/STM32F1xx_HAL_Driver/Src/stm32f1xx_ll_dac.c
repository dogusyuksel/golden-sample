...
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                   \
    (((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM3_TRGO) ||          \
     ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM15_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) ||    \
     ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM4_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM5_TRGO) ||     \
     ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM6_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM7_TRGO) ||     \
     ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM8_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_EXTI_LINE9))
...
ErrorStatus LL_DAC_Init(DAC_TypeDef *DACx, uint32_t DAC_Channel, const LL_DAC_InitTypeDef *DAC_InitStruct) {
    ...
    if (LL_DAC_IsEnabled(DACx, DAC_Channel) == 0UL) {
        ...
        if (DAC_InitStruct->WaveAutoGeneration != LL_DAC_WAVE_AUTO_GENERATION_NONE) {
            MODIFY_REG(DACx->CR,
                       (DAC_CR_TSEL1 | DAC_CR_WAVE1 | DAC_CR_MAMP1 | DAC_CR_BOFF1)
            ...
            MODIFY_REG(DACx->CR,
                       (DAC_CR_TSEL1 | DAC_CR_WAVE1 | DAC_CR_BOFF1) << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK),
                       (DAC_InitStruct->TriggerSource | LL_DAC_WAVE_AUTO_GENERATION_NONE | DAC_InitStruct->OutputBuffer)
                           << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK));
        }
    } else {
