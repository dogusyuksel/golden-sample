...
#define __HAL_USART_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                                               \
    ((((__INTERRUPT__) >> 28U) == USART_CR1_REG_INDEX)                                                                 \
         ? ((__HANDLE__)->Instance->CR1 |= ((__INTERRUPT__)&USART_IT_MASK))                                            \
     : (((__INTERRUPT__) >> 28U) == USART_CR2_REG_INDEX)                                                               \
         ? ((__HANDLE__)->Instance->CR2 |= ((__INTERRUPT__)&USART_IT_MASK))                                            \
...
#define __HAL_USART_GET_IT_SOURCE(__HANDLE__, __IT__)                                                                  \
    (((((__IT__) >> 28U) == USART_CR1_REG_INDEX)                                                                       \
          ? (__HANDLE__)->Instance->CR1                                                                                \
          : (((((uint32_t)(__IT__)) >> 28U) == USART_CR2_REG_INDEX) ? (__HANDLE__)->Instance->CR2                      \
                                                                    : (__HANDLE__)->Instance->CR3)) &                  \
     (((uint32_t)(__IT__)) & USART_IT_MASK))
...
#define USART_IT_MASK                                                                                                  \
    ((uint32_t)USART_CR1_PEIE | USART_CR1_TXEIE | USART_CR1_TCIE | USART_CR1_RXNEIE | USART_CR1_IDLEIE |               \
     USART_CR2_LBDIE | USART_CR3_CTSIE | USART_CR3_EIE)
...
#define IS_USART_STOPBITS(STOPBITS)                                                                                    \
    (((STOPBITS) == USART_STOPBITS_1) || ((STOPBITS) == USART_STOPBITS_0_5) || ((STOPBITS) == USART_STOPBITS_1_5) ||   \
...
#define USART_BRR(_PCLK_, _BAUD_)                                                                                      \
    (((USART_DIVMANT((_PCLK_), (_BAUD_)) << 4U) + ((USART_DIVFRAQ((_PCLK_), (_BAUD_)) & 0xF0U) << 1U)) +               \
