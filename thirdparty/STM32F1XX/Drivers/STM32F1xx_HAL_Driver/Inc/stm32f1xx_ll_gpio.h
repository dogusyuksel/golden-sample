...
typedef struct {
    ...
    uint32_t Speed; /*!< Specifies the speed for the selected pins.
                         ...
                         GPIO HW configuration can be modified afterwards using unitary function @ref
                       LL_GPIO_SetPinSpeed().*/
    ...
    uint32_t
        Pull; /*!< Specifies the operating Pull-up/Pull down for the selected pins.
...
#define LL_GPIO_PIN_ALL                                                                                                \
    (LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6 |   \
     LL_GPIO_PIN_7 | LL_GPIO_PIN_8 | LL_GPIO_PIN_9 | LL_GPIO_PIN_10 | LL_GPIO_PIN_11 | LL_GPIO_PIN_12 |                \
     LL_GPIO_PIN_13 | LL_GPIO_PIN_14 | LL_GPIO_PIN_15) /*!< Select all pins */
/**
 * @}
 */
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinMode(GPIO_TypeDef *GPIOx, uint32_t Pin) {
    register uint32_t *pReg = (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
    return (READ_BIT(*pReg, ((GPIO_CRL_CNF0 | GPIO_CRL_MODE0) << (POSITION_VAL(Pin) * 4U))) >>
            (POSITION_VAL(Pin) * 4U));
}
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinPull(GPIO_TypeDef *GPIOx, uint32_t Pin) {
    return (READ_BIT(GPIOx->ODR, (GPIO_ODR_ODR0 << (POSITION_VAL(Pin >> GPIO_PIN_MASK_POS)))) >>
...
__STATIC_INLINE uint32_t LL_GPIO_IsPinLocked(GPIO_TypeDef *GPIOx, uint32_t PinMask) {
    return (READ_BIT(GPIOx->LCKR, ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU)) ==
...
/**
 * @brief Enable the remapping of TIM1 alternate function channels 1 to 4, 1N to 3N, external trigger (ETR) and Break
 * input (BKIN)
 * @rmtoll MAPR          TIM1_REMAP           LL_GPIO_AF_EnableRemap_TIM1
 * @note  ENABLE: Full remap     (ETR/PE7,  CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15, CH1N/PE8,  CH2N/PE10,
 * CH3N/PE12)
 * @retval None
 */
 ...
 * @note  PARTIAL: Partial remap (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PA6,  CH1N/PA7,  CH2N/PB0,
 * CH3N/PB1)
 * @retval None
 */
...
/**
 * @brief Disable the remapping of TIM1 alternate function channels 1 to 4, 1N to 3N, external trigger (ETR) and Break
 * input (BKIN)
 * @rmtoll MAPR          TIM1_REMAP           LL_GPIO_AF_DisableRemap_TIM1
 * @note  DISABLE: No remap      (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PB12, CH1N/PB13, CH2N/PB14,
 * CH3N/PB15)
 * @retval None
 */
...
/**
 * @brief Enable or disable the remapping of CAN alternate function CAN_RX and CAN_TX in devices with a single CAN
 * interface.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_ETH(void) { SET_BIT(AFIO->MAPR, AFIO_MAPR_ETH_REMAP | AFIO_MAPR_SWJ_CFG); }
...
/**
 * @brief Enable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS, SPI3_SCK/I2S3_CK, SPI3_MISO,
 * SPI3_MOSI/I2S3_SD.
...
/**
 * @brief Disable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS, SPI3_SCK/I2S3_CK, SPI3_MISO,
 * SPI3_MOSI/I2S3_SD.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM9(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM9_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM9(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM9_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM10(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM10_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM10(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM10_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM11(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM11_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM11(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM11_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM13(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM13_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM13(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM13_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM14(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM14_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM14(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM14_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_Disconnect_FSMCNADV(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_FSMC_NADV_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_Connect_FSMCNADV(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_FSMC_NADV_REMAP); }
#endif
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM15(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM15_REMAP); }
/**
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM15(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM15_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM16(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM16_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM16(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM16_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM17(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM17_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM17(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM17_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_CEC(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_CEC_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_CEC(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_CEC_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM1DMA(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM1_DMA_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM1DMA(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM1_DMA_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM67DACDMA(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM67_DAC_DMA_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM12(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM12_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM12(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM12_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_MISC(void) { SET_BIT(AFIO->MAPR2, AFIO_MAPR2_MISC_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_MISC(void) { CLEAR_BIT(AFIO->MAPR2, AFIO_MAPR2_MISC_REMAP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableEventout(void) { SET_BIT(AFIO->EVCR, AFIO_EVCR_EVOE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableEventout(void) { CLEAR_BIT(AFIO->EVCR, AFIO_EVCR_EVOE); }
