...
#define EXTI_LINE_18                                                                                                   \
    (EXTI_CONFIG | 0x12u) /*!< External interrupt line 18 Connected to the USB Wakeup from suspend event */
#endif                    /* EXTI_IMR_IM18 */
...
#define IS_EXTI_LINE(__EXTI_LINE__)                                                                                    \
    ((((__EXTI_LINE__) & ~(EXTI_PROPERTY_MASK | EXTI_PIN_MASK)) == 0x00u) &&                                           \
     ((((__EXTI_LINE__)&EXTI_PROPERTY_MASK) == EXTI_CONFIG) || (((__EXTI_LINE__)&EXTI_PROPERTY_MASK) == EXTI_GPIO)) && \
...
#define IS_EXTI_GPIO_PORT(__PORT__)                                                                                    \
    (((__PORT__) == EXTI_GPIOA) || ((__PORT__) == EXTI_GPIOB) || ((__PORT__) == EXTI_GPIOC) ||                         \
     ((__PORT__) == EXTI_GPIOD) || ((__PORT__) == EXTI_GPIOE))
#else
#define IS_EXTI_GPIO_PORT(__PORT__)                                                                                    \
    (((__PORT__) == EXTI_GPIOA) || ((__PORT__) == EXTI_GPIOB) || ((__PORT__) == EXTI_GPIOC) ||                         \
     ((__PORT__) == EXTI_GPIOD))
