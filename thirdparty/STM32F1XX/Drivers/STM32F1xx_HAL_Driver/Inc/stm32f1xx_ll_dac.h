...
#define DAC_REG_DHRX_REGOFFSET_MASK                                                                                    \
    (DAC_REG_DHR12RX_REGOFFSET_MASK | DAC_REG_DHR12LX_REGOFFSET_MASK | DAC_REG_DHR8RX_REGOFFSET_MASK)
...
#define LL_DAC_CHANNEL_1                                                                                               \
    (DAC_REG_DOR1_REGOFFSET | DAC_REG_DHR12R1_REGOFFSET | DAC_REG_DHR12L1_REGOFFSET | DAC_REG_DHR8R1_REGOFFSET |       \
     DAC_CR_CH1_BITOFFSET | DAC_SWTR_CH1) /*!< DAC channel 1 */

#define LL_DAC_CHANNEL_2                                                                                               \
    (DAC_REG_DOR2_REGOFFSET | DAC_REG_DHR12R2_REGOFFSET | DAC_REG_DHR12L2_REGOFFSET | DAC_REG_DHR8R2_REGOFFSET |       \
...
#define LL_DAC_TRIG_SOFTWARE                                                                                           \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger internal (SW start) */
#define LL_DAC_TRIG_EXT_TIM3_TRGO                                                                                      \
    (DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external peripheral: TIM3 TRGO. */
#define LL_DAC_TRIG_EXT_TIM15_TRGO                                                                                     \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external peripheral: TIM15 TRGO. */
#define LL_DAC_TRIG_EXT_TIM2_TRGO                                                                                      \
    (DAC_CR_TSEL1_2) /*!< DAC channel conversion trigger from external peripheral: TIM2 TRGO. */
...
#define LL_DAC_TRIG_EXT_TIM4_TRGO                                                                                      \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external peripheral: TIM4 TRGO. */
#define LL_DAC_TRIG_EXT_TIM6_TRGO                                                                                      \
    0x00000000UL /*!< DAC channel conversion trigger from external peripheral: TIM6 TRGO. */
...
#define LL_DAC_TRIG_EXT_TIM5_TRGO                                                                                      \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external peripheral: TIM5 TRGO. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9                                                                                     \
    (DAC_CR_TSEL1_2 |                                                                                                  \
     DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external peripheral: external interrupt line 9. */
/**
 * @}
 */
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS3_0                                                                               \
    (DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR bits[3:0], for the selected DAC channel  \
                                       */
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS5_0                                                                               \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR bits[5:0], for the selected DAC channel  \
                                       */
#define LL_DAC_NOISE_LFSR_UNMASK_BITS6_0                                                                               \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1) /*!< Noise wave generation, unmask LFSR bits[6:0], for the selected DAC channel  \
                                       */
...
#define LL_DAC_NOISE_LFSR_UNMASK_BITS9_0                                                                               \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0) /*!< Noise wave generation, unmask LFSR bits[9:0], for the selected DAC channel  \
                                       */
...
#define LL_DAC_TRIANGLE_AMPLITUDE_3                                                                                    \
    (DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 3 LSB of DAC output range, for the selected DAC       \
                        channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_7                                                                                    \
    (DAC_CR_MAMP1_1) /*!< Triangle wave generation, amplitude of 7 LSB of DAC output range, for the selected DAC       \
                        channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_15                                                                                   \
    (DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 15 LSB of DAC output range, for the  \
                                         selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_31                                                                                   \
    (DAC_CR_MAMP1_2) /*!< Triangle wave generation, amplitude of 31 LSB of DAC output range, for the selected DAC      \
                        channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_63                                                                                   \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 63 LSB of DAC output range, for the  \
                                         selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_127                                                                                  \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1) /*!< Triangle wave generation, amplitude of 127 LSB of DAC output range, for the \
                                         selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_255                                                                                  \
    (DAC_CR_MAMP1_2 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 255 LSB of DAC      \
                                                          output range, for the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_511                                                                                  \
    (DAC_CR_MAMP1_3) /*!< Triangle wave generation, amplitude of 512 LSB of DAC output range, for the selected DAC     \
                        channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_1023                                                                                 \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 1023 LSB of DAC output range, for    \
                                         the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_2047                                                                                 \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1) /*!< Triangle wave generation, amplitude of 2047 LSB of DAC output range, for    \
                                         the selected DAC channel */
#define LL_DAC_TRIANGLE_AMPLITUDE_4095                                                                                 \
    (DAC_CR_MAMP1_3 | DAC_CR_MAMP1_1 | DAC_CR_MAMP1_0) /*!< Triangle wave generation, amplitude of 4095 LSB of DAC     \
                                                          output range, for the selected DAC channel */
/**
 * @}
 */
...
#define LL_DAC_OUTPUT_BUFFER_ENABLE                                                                                    \
    0x00000000UL /*!< The selected DAC channel output is buffered: higher drive current capability, but also higher    \
                    current consumption */
#define LL_DAC_OUTPUT_BUFFER_DISABLE                                                                                   \
    (DAC_CR_BOFF1) /*!< The selected DAC channel output is not buffered: lower drive current capability, but also      \
...
#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                                                                       \
    15UL /*!< Delay for DAC channel voltage settling time from DAC channel startup (transition from disable to enable) \
          */
...
__STATIC_INLINE uint32_t LL_DAC_IsDMAReqEnabled(const DAC_TypeDef *DACx, uint32_t DAC_Channel) {
    return ((READ_BIT(DACx->CR, DAC_CR_DMAEN1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK)) ==
...
__STATIC_INLINE uint32_t LL_DAC_DMA_GetRegAddr(const DAC_TypeDef *DACx, uint32_t DAC_Channel, uint32_t Register) {
    ...
    return ((uint32_t)(__DAC_PTR_REG_OFFSET(
        (DACx)->DHR12R1, ((DAC_Channel >> (Register & 0x1FUL)) & DAC_REG_DHR_REGOFFSET_MASK_POSBIT0))));
}
/**
 * @}
 */
...
__STATIC_INLINE uint32_t LL_DAC_IsEnabled(const DAC_TypeDef *DACx, uint32_t DAC_Channel) {
    return ((READ_BIT(DACx->CR, DAC_CR_EN1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK)) ==
...
__STATIC_INLINE uint32_t LL_DAC_IsTriggerEnabled(const DAC_TypeDef *DACx, uint32_t DAC_Channel) {
    return ((READ_BIT(DACx->CR, DAC_CR_TEN1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK)) ==
...
__STATIC_INLINE void LL_DAC_ConvertDualData12LeftAligned(DAC_TypeDef *DACx, uint32_t DataChannel1,
    ...
    MODIFY_REG(DACx->DHR12LD, (DAC_DHR12LD_DACC2DHR | DAC_DHR12LD_DACC1DHR),
