...
#define IS_FLASH_PROGRAM_ADDRESS(ADDRESS)                                                                              \
    (((ADDRESS) >= FLASH_BASE) &&                                                                                      \
     (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x20U) ? ((ADDRESS) <= FLASH_BANK1_END)                            \
                                                           : ((ADDRESS) <= 0x08003FFFU)))
...
#define IS_FLASH_PROGRAM_ADDRESS(ADDRESS)                                                                              \
    (((ADDRESS) >= FLASH_BASE) &&                                                                                      \
     (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x80U)                                                             \
          ...
          : (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x40U)                                                      \
                 ? ((ADDRESS) <= 0x0800FFFF)                                                                           \
                 : (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x20U) ? ((ADDRESS) <= 0x08007FFF)                   \
                                                                         : ((ADDRESS) <= 0x08003FFFU)))))
...
#define IS_FLASH_PROGRAM_ADDRESS(ADDRESS)                                                                              \
    (((ADDRESS) >= FLASH_BASE) &&                                                                                      \
     (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x200U)                                                            \
          ? ((ADDRESS) <= FLASH_BANK1_END)                                                                             \
          : (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x180U) ? ((ADDRESS) <= 0x0805FFFFU)                        \
                                                                   : ((ADDRESS) <= 0x0803FFFFU))))
...
#define IS_FLASH_PROGRAM_ADDRESS(ADDRESS)                                                                              \
    (((ADDRESS) >= FLASH_BASE) &&                                                                                      \
     (((*((uint16_t *)FLASH_SIZE_DATA_REGISTER)) == 0x400U) ? ((ADDRESS) <= FLASH_BANK2_END)                           \
                                                            : ((ADDRESS) <= 0x080BFFFFU)))
...
typedef struct {
    ...
    uint32_t PageAddress; /*!< PageAdress: Initial FLASH page address to erase when mass erase is disabled
                               This parameter must be a number between Min_Data = 0x08000000 and Max_Data =
                             FLASH_BANKx_END (x = 1 or 2 depending on devices)*/

    uint32_t NbPages; /*!< NbPages: Number of pagess to be erased.
                           This parameter must be a value between Min_Data = 1 and Max_Data = (max number of pages -
...
#if defined(FLASH_BANK2_END)
    uint8_t
        USERConfig; /*!< USERConfig: Program the FLASH User Option Byte:
 ...
 * @{
 */
#if (defined(STM32F101x6) || defined(STM32F102x6) || defined(STM32F103x6) || defined(STM32F100xB) ||                   \
     defined(STM32F101xB) || defined(STM32F102xB) || defined(STM32F103xB))
#define FLASH_PAGE_SIZE 0x400U
#endif /* STM32F101x6 || STM32F102x6 || STM32F103x6 */
       /* STM32F100xB || STM32F101xB || STM32F102xB || STM32F103xB */

#if (defined(STM32F100xE) || defined(STM32F101xE) || defined(STM32F103xE) || defined(STM32F101xG) ||                   \
...
#define __HAL_FLASH_GET_FLAG(__FLAG__)                                                                                 \
    (((__FLAG__) == FLASH_FLAG_OPTVERR)                                                                                \
         ...
         : ((((__FLAG__)&SR_FLAG_MASK) != RESET) ? (FLASH->SR & ((__FLAG__)&SR_FLAG_MASK))                             \
