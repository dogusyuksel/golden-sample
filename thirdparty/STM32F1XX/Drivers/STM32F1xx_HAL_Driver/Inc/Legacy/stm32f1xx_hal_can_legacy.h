...
#define CAN_FLAG_RQCP0                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_RQCP0_BIT_POSITION)) /*!< Request MailBox0 flag         */
#define CAN_FLAG_RQCP1                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_RQCP1_BIT_POSITION)) /*!< Request MailBox1 flag         */
#define CAN_FLAG_RQCP2                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_RQCP2_BIT_POSITION)) /*!< Request MailBox2 flag         */
#define CAN_FLAG_TXOK0                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_TXOK0_BIT_POSITION)) /*!< Transmission OK MailBox0 flag */
#define CAN_FLAG_TXOK1                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_TXOK1_BIT_POSITION)) /*!< Transmission OK MailBox1 flag */
#define CAN_FLAG_TXOK2                                                                                                 \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_TXOK2_BIT_POSITION)) /*!< Transmission OK MailBox2 flag */
#define CAN_FLAG_TME0                                                                                                  \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_TME0_BIT_POSITION)) /*!< Transmit mailbox 0 empty flag */
#define CAN_FLAG_TME1                                                                                                  \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) | CAN_TSR_TME1_BIT_POSITION)) /*!< Transmit mailbox 0 empty flag */
...
#define CAN_FLAG_SLAK                                                                                                  \
    ((uint32_t)((MSR_REGISTER_INDEX << 8U) | CAN_MSR_SLAK_BIT_POSITION)) /*!< Sleep acknowledge flag */
#define CAN_FLAG_SLAKI                                                                                                 \
    ((uint32_t)((MSR_REGISTER_INDEX << 8U) | CAN_MSR_SLAKI_BIT_POSITION)) /*!< Sleep acknowledge flag */
...
#define __HAL_CAN_MSG_PENDING(__HANDLE__, __FIFONUMBER__)                                                              \
    (((__FIFONUMBER__) == CAN_FIFO0) ? ((uint8_t)((__HANDLE__)->Instance->RF0R & 0x03U))                               \
                                     : ((uint8_t)((__HANDLE__)->Instance->RF1R & 0x03U)))
...
#define __HAL_CAN_TRANSMIT_STATUS(__HANDLE__, __TRANSMITMAILBOX__)                                                     \
    (((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_0)                                                                        \
         ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP0 | CAN_TSR_TME0)) == (CAN_TSR_RQCP0 | CAN_TSR_TME0))        \
     : ((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_1)                                                                      \
         ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP1 | CAN_TSR_TME1)) == (CAN_TSR_RQCP1 | CAN_TSR_TME1))        \
