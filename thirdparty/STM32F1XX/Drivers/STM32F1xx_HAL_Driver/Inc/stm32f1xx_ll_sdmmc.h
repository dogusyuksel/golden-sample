...
#define SDMMC_ERROR_WRITE_PROT_VIOLATION                                                                               \
    0x00000400U /*!< Attempt to program a write protect block                      */
...
#define SDMMC_ERROR_GENERAL_UNKNOWN_ERR                                                                                \
    0x00010000U /*!< General or unknown error                                      */
#define SDMMC_ERROR_STREAM_READ_UNDERRUN                                                                               \
    0x00020000U /*!< The card could not sustain data reading in stream rmode       */
...
#define SDMMC_CMD_SEND_OP_COND                                                                                         \
    1U /*!< Sends host capacity support information and activates the card's initialization process. */
#define SDMMC_CMD_ALL_SEND_CID                                                                                         \
    2U /*!< Asks any card connected to the host to send the CID numbers on the CMD line.             */
...
#define SDMMC_CMD_SDMMC_SEN_OP_COND                                                                                    \
    5U /*!< Sends host capacity support information (HCS) and asks the accessed card to send its                       \
            operating condition register (OCR) content in the response on the CMD line.              */
#define SDMMC_CMD_HS_SWITCH                                                                                            \
    6U /*!< Checks switchable function (mode 0) and switch card function (mode 1).                   */
#define SDMMC_CMD_SEL_DESEL_CARD                                                                                       \
    7U /*!< Selects the card by its own relative address and gets deselected by any other address    */
#define SDMMC_CMD_HS_SEND_EXT_CSD                                                                                      \
    8U /*!< Sends SD Memory Card interface condition, which includes host supply voltage information                   \
            and asks the card whether card supports voltage.                                         */
#define SDMMC_CMD_SEND_CSD                                                                                             \
    9U /*!< Addressed card sends its card specific data (CSD) on the CMD line.                       */
#define SDMMC_CMD_SEND_CID                                                                                             \
    10U /*!< Addressed card sends its card identification (CID) on the CMD line.                      */
#define SDMMC_CMD_READ_DAT_UNTIL_STOP                                                                                  \
    11U /*!< SD card doesn't support it.                                                              */
...
#define SDMMC_CMD_SET_BLOCKLEN                                                                                         \
    16U /*!< Sets the block length (in bytes for SDSC) for all following block commands                                \
             (read, write, lock). Default block length is fixed to 512 Bytes. Not effective                            \
             for SDHS and SDXC.                                                                       */
#define SDMMC_CMD_READ_SINGLE_BLOCK                                                                                    \
    17U /*!< Reads single block of size selected by SET_BLOCKLEN in case of SDSC, and a block of                       \
             fixed 512 bytes in case of SDHC and SDXC.                                                */
#define SDMMC_CMD_READ_MULT_BLOCK                                                                                      \
    18U /*!< Continuously transfers data blocks from card to host until interrupted by                                 \
...
#define SDMMC_CMD_WRITE_SINGLE_BLOCK                                                                                   \
    24U /*!< Writes single block of size selected by SET_BLOCKLEN in case of SDSC, and a block of                      \
             fixed 512 bytes in case of SDHC and SDXC.                                                */
#define SDMMC_CMD_WRITE_MULT_BLOCK                                                                                     \
    25U /*!< Continuously writes blocks of data until a STOP_TRANSMISSION follows.                    */
...
#define SDMMC_CMD_SET_WRITE_PROT                                                                                       \
    28U /*!< Sets the write protection bit of the addressed group.                                    */
#define SDMMC_CMD_CLR_WRITE_PROT                                                                                       \
    29U /*!< Clears the write protection bit of the addressed group.                                  */
#define SDMMC_CMD_SEND_WRITE_PROT                                                                                      \
    30U /*!< Asks the card to send the status of the write protection bits.                           */
#define SDMMC_CMD_SD_ERASE_GRP_START                                                                                   \
    32U /*!< Sets the address of the first write block to be erased. (For SD card only).              */
#define SDMMC_CMD_SD_ERASE_GRP_END                                                                                     \
    33U /*!< Sets the address of the last write block of the continuous range to be erased.           */
#define SDMMC_CMD_ERASE_GRP_START                                                                                      \
    35U /*!< Sets the address of the first write block to be erased. Reserved for each command                         \
             system set by switch function command (CMD6).                                            */
#define SDMMC_CMD_ERASE_GRP_END                                                                                        \
    36U /*!< Sets the address of the last write block of the continuous range to be erased.                            \
...
#define SDMMC_CMD_LOCK_UNLOCK                                                                                          \
    42U /*!< Sets/resets the password or lock/unlock the card. The size of the data block is set by                    \
             the SET_BLOCK_LEN command.                                                               */
#define SDMMC_CMD_APP_CMD                                                                                              \
    55U /*!< Indicates to the card that the next command is an application specific command rather                     \
             than a standard command.                                                                 */
#define SDMMC_CMD_GEN_CMD                                                                                              \
    56U /*!< Used either to transfer a data block to the card or to get a data block from the card                     \
...
#define SDMMC_CMD_APP_SD_SET_BUSWIDTH                                                                                  \
    6U /*!< (ACMD6) Defines the data bus width to be used for data transfer. The allowed data bus                      \
             widths are given in SCR register.                                                       */
#define SDMMC_CMD_SD_APP_STATUS                                                                                        \
    13U /*!< (ACMD13) Sends the SD status.                                                            */
#define SDMMC_CMD_SD_APP_SEND_NUM_WRITE_BLOCKS                                                                         \
    22U /*!< (ACMD22) Sends the number of the written (without errors) write blocks. Responds with                     \
             32bit+CRC data block.                                                                    */
#define SDMMC_CMD_SD_APP_OP_COND                                                                                       \
    41U /*!< (ACMD41) Sends host capacity support information (HCS) and asks the accessed card to                      \
             send its operating condition register (OCR) content in the response on the CMD line.     */
#define SDMMC_CMD_SD_APP_SET_CLR_CARD_DETECT                                                                           \
    42U /*!< (ACMD42) Connect/Disconnect the 50 KOhm pull-up resistor on CD/DAT3 (pin 1) of the card  */
#define SDMMC_CMD_SD_APP_SEND_SCR                                                                                      \
    51U /*!< Reads the SD Configuration Register (SCR).                                               */
#define SDMMC_CMD_SDMMC_RW_DIRECT                                                                                      \
    52U /*!< For SD I/O card only, reserved for security specification.                               */
#define SDMMC_CMD_SDMMC_RW_EXTENDED                                                                                    \
    53U /*!< For SD I/O card only, reserved for security specification.                               */
...
#define IS_SDIO_CLOCK_POWER_SAVE(SAVE)                                                                                 \
    (((SAVE) == SDIO_CLOCK_POWER_SAVE_DISABLE) || ((SAVE) == SDIO_CLOCK_POWER_SAVE_ENABLE))
/**
 * @}
 */
...
#define IS_SDIO_BUS_WIDE(WIDE)                                                                                         \
    (((WIDE) == SDIO_BUS_WIDE_1B) || ((WIDE) == SDIO_BUS_WIDE_4B) || ((WIDE) == SDIO_BUS_WIDE_8B))
/**
 * @}
 */
...
#define IS_SDIO_HARDWARE_FLOW_CONTROL(CONTROL)                                                                         \
    (((CONTROL) == SDIO_HARDWARE_FLOW_CONTROL_DISABLE) || ((CONTROL) == SDIO_HARDWARE_FLOW_CONTROL_ENABLE))
/**
 * @}
 */
...
#define IS_SDIO_RESPONSE(RESPONSE)                                                                                     \
    (((RESPONSE) == SDIO_RESPONSE_NO) || ((RESPONSE) == SDIO_RESPONSE_SHORT) || ((RESPONSE) == SDIO_RESPONSE_LONG))
/**
 * @}
 */
...
#define IS_SDIO_RESP(RESP)                                                                                             \
    (((RESP) == SDIO_RESP1) || ((RESP) == SDIO_RESP2) || ((RESP) == SDIO_RESP3) || ((RESP) == SDIO_RESP4))
/**
 * @}
 */
...
#define IS_SDIO_BLOCK_SIZE(SIZE)                                                                                       \
    (((SIZE) == SDIO_DATABLOCK_SIZE_1B) || ((SIZE) == SDIO_DATABLOCK_SIZE_2B) || ((SIZE) == SDIO_DATABLOCK_SIZE_4B) || \
     ((SIZE) == SDIO_DATABLOCK_SIZE_8B) || ((SIZE) == SDIO_DATABLOCK_SIZE_16B) ||                                      \
     ((SIZE) == SDIO_DATABLOCK_SIZE_32B) || ((SIZE) == SDIO_DATABLOCK_SIZE_64B) ||                                     \
     ((SIZE) == SDIO_DATABLOCK_SIZE_128B) || ((SIZE) == SDIO_DATABLOCK_SIZE_256B) ||                                   \
     ((SIZE) == SDIO_DATABLOCK_SIZE_512B) || ((SIZE) == SDIO_DATABLOCK_SIZE_1024B) ||                                  \
     ((SIZE) == SDIO_DATABLOCK_SIZE_2048B) || ((SIZE) == SDIO_DATABLOCK_SIZE_4096B) ||                                 \
...
#define SDIO_STATIC_FLAGS                                                                                              \
    ((uint32_t)(SDIO_FLAG_CCRCFAIL | SDIO_FLAG_DCRCFAIL | SDIO_FLAG_CTIMEOUT | SDIO_FLAG_DTIMEOUT |                    \
                SDIO_FLAG_TXUNDERR | SDIO_FLAG_RXOVERR | SDIO_FLAG_CMDREND | SDIO_FLAG_CMDSENT | SDIO_FLAG_DATAEND |   \
                SDIO_FLAG_DBCKEND | SDIO_FLAG_SDIOIT))

#define SDIO_STATIC_CMD_FLAGS                                                                                          \
    ((uint32_t)(SDIO_FLAG_CCRCFAIL | SDIO_FLAG_CTIMEOUT | SDIO_FLAG_CMDREND | SDIO_FLAG_CMDSENT))

#define SDIO_STATIC_DATA_FLAGS                                                                                         \
    ((uint32_t)(SDIO_FLAG_DCRCFAIL | SDIO_FLAG_DTIMEOUT | SDIO_FLAG_TXUNDERR | SDIO_FLAG_RXOVERR | SDIO_FLAG_DATAEND | \
                SDIO_FLAG_DBCKEND))
/**
 * @}
 */
...
#define CLKCR_CLEAR_MASK                                                                                               \
    ((uint32_t)(SDIO_CLKCR_CLKDIV | SDIO_CLKCR_PWRSAV | SDIO_CLKCR_BYPASS | SDIO_CLKCR_WIDBUS | SDIO_CLKCR_NEGEDGE |   \
                SDIO_CLKCR_HWFC_EN))
...
#define CMD_CLEAR_MASK                                                                                                 \
    ((uint32_t)(SDIO_CMD_CMDINDEX | SDIO_CMD_WAITRESP | SDIO_CMD_WAITINT | SDIO_CMD_WAITPEND | SDIO_CMD_CPSMEN |       \
