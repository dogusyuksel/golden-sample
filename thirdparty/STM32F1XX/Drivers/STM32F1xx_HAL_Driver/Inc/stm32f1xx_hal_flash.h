...
#define IS_FLASH_LATENCY(__LATENCY__)                                                                                  \
    (((__LATENCY__) == FLASH_LATENCY_0) || ((__LATENCY__) == FLASH_LATENCY_1) || ((__LATENCY__) == FLASH_LATENCY_2))
...
typedef struct {
    ...
    __IO uint32_t DataRemaining; /*!< Internal variable to save the remaining pages to erase or half-word to program in
                                    IT context */
