...
#define IS_ETH_AUTONEGOTIATION(CMD) (((CMD) == ETH_AUTONEGOTIATION_ENABLE) || ((CMD) == ETH_AUTONEGOTIATION_DISABLE))
...
#define IS_ETH_RX_MODE(MODE) (((MODE) == ETH_RXPOLLING_MODE) || ((MODE) == ETH_RXINTERRUPT_MODE))
#define IS_ETH_CHECKSUM_MODE(MODE) (((MODE) == ETH_CHECKSUM_BY_HARDWARE) || ((MODE) == ETH_CHECKSUM_BY_SOFTWARE))
#define IS_ETH_MEDIA_INTERFACE(MODE) (((MODE) == ETH_MEDIA_INTERFACE_MII) || ((MODE) == ETH_MEDIA_INTERFACE_RMII))
#define IS_ETH_WATCHDOG(CMD) (((CMD) == ETH_WATCHDOG_ENABLE) || ((CMD) == ETH_WATCHDOG_DISABLE))
#define IS_ETH_JABBER(CMD) (((CMD) == ETH_JABBER_ENABLE) || ((CMD) == ETH_JABBER_DISABLE))
#define IS_ETH_INTER_FRAME_GAP(GAP)                                                                                    \
    (((GAP) == ETH_INTERFRAMEGAP_96BIT) || ((GAP) == ETH_INTERFRAMEGAP_88BIT) || ((GAP) == ETH_INTERFRAMEGAP_80BIT) || \
     ((GAP) == ETH_INTERFRAMEGAP_72BIT) || ((GAP) == ETH_INTERFRAMEGAP_64BIT) || ((GAP) == ETH_INTERFRAMEGAP_56BIT) || \
     ((GAP) == ETH_INTERFRAMEGAP_48BIT) || ((GAP) == ETH_INTERFRAMEGAP_40BIT))
#define IS_ETH_CARRIER_SENSE(CMD) (((CMD) == ETH_CARRIERSENCE_ENABLE) || ((CMD) == ETH_CARRIERSENCE_DISABLE))
#define IS_ETH_RECEIVE_OWN(CMD) (((CMD) == ETH_RECEIVEOWN_ENABLE) || ((CMD) == ETH_RECEIVEOWN_DISABLE))
#define IS_ETH_LOOPBACK_MODE(CMD) (((CMD) == ETH_LOOPBACKMODE_ENABLE) || ((CMD) == ETH_LOOPBACKMODE_DISABLE))
...
#define IS_ETH_BACKOFF_LIMIT(LIMIT)                                                                                    \
    (((LIMIT) == ETH_BACKOFFLIMIT_10) || ((LIMIT) == ETH_BACKOFFLIMIT_8) || ((LIMIT) == ETH_BACKOFFLIMIT_4) ||         \
     ((LIMIT) == ETH_BACKOFFLIMIT_1))
#define IS_ETH_DEFERRAL_CHECK(CMD) (((CMD) == ETH_DEFFERRALCHECK_ENABLE) || ((CMD) == ETH_DEFFERRALCHECK_DISABLE))
#define IS_ETH_RECEIVE_ALL(CMD) (((CMD) == ETH_RECEIVEALL_ENABLE) || ((CMD) == ETH_RECEIVEAll_DISABLE))
#define IS_ETH_SOURCE_ADDR_FILTER(CMD)                                                                                 \
    (((CMD) == ETH_SOURCEADDRFILTER_NORMAL_ENABLE) || ((CMD) == ETH_SOURCEADDRFILTER_INVERSE_ENABLE) ||                \
     ((CMD) == ETH_SOURCEADDRFILTER_DISABLE))
#define IS_ETH_CONTROL_FRAMES(PASS)                                                                                    \
    (((PASS) == ETH_PASSCONTROLFRAMES_BLOCKALL) || ((PASS) == ETH_PASSCONTROLFRAMES_FORWARDALL) ||                     \
...
#define IS_ETH_PROMISCUOUS_MODE(CMD) (((CMD) == ETH_PROMISCUOUS_MODE_ENABLE) || ((CMD) == ETH_PROMISCUOUS_MODE_DISABLE))
#define IS_ETH_MULTICAST_FRAMES_FILTER(FILTER)                                                                         \
    (((FILTER) == ETH_MULTICASTFRAMESFILTER_PERFECTHASHTABLE) || ((FILTER) == ETH_MULTICASTFRAMESFILTER_HASHTABLE) ||  \
     ((FILTER) == ETH_MULTICASTFRAMESFILTER_PERFECT) || ((FILTER) == ETH_MULTICASTFRAMESFILTER_NONE))
#define IS_ETH_UNICAST_FRAMES_FILTER(FILTER)                                                                           \
    (((FILTER) == ETH_UNICASTFRAMESFILTER_PERFECTHASHTABLE) || ((FILTER) == ETH_UNICASTFRAMESFILTER_HASHTABLE) ||      \
...
#define IS_ETH_PAUSE_LOW_THRESHOLD(THRESHOLD)                                                                          \
    (((THRESHOLD) == ETH_PAUSELOWTHRESHOLD_MINUS4) || ((THRESHOLD) == ETH_PAUSELOWTHRESHOLD_MINUS28) ||                \
     ((THRESHOLD) == ETH_PAUSELOWTHRESHOLD_MINUS144) || ((THRESHOLD) == ETH_PAUSELOWTHRESHOLD_MINUS256))
...
#define IS_ETH_MAC_ADDRESS0123(ADDRESS)                                                                                \
    (((ADDRESS) == ETH_MAC_ADDRESS0) || ((ADDRESS) == ETH_MAC_ADDRESS1) || ((ADDRESS) == ETH_MAC_ADDRESS2) ||          \
...
#define IS_ETH_MAC_ADDRESS_MASK(MASK)                                                                                  \
    (((MASK) == ETH_MAC_ADDRESSMASK_BYTE6) || ((MASK) == ETH_MAC_ADDRESSMASK_BYTE5) ||                                 \
     ((MASK) == ETH_MAC_ADDRESSMASK_BYTE4) || ((MASK) == ETH_MAC_ADDRESSMASK_BYTE3) ||                                 \
     ((MASK) == ETH_MAC_ADDRESSMASK_BYTE2) || ((MASK) == ETH_MAC_ADDRESSMASK_BYTE1))
...
#define IS_ETH_TRANSMIT_THRESHOLD_CONTROL(THRESHOLD)                                                                   \
    (((THRESHOLD) == ETH_TRANSMITTHRESHOLDCONTROL_64BYTES) ||                                                          \
     ...
     ((THRESHOLD) == ETH_TRANSMITTHRESHOLDCONTROL_40BYTES) || ((THRESHOLD) == ETH_TRANSMITTHRESHOLDCONTROL_32BYTES) || \
     ((THRESHOLD) == ETH_TRANSMITTHRESHOLDCONTROL_24BYTES) || ((THRESHOLD) == ETH_TRANSMITTHRESHOLDCONTROL_16BYTES))
...
#define IS_ETH_RECEIVE_THRESHOLD_CONTROL(THRESHOLD)                                                                    \
    (((THRESHOLD) == ETH_RECEIVEDTHRESHOLDCONTROL_64BYTES) || ((THRESHOLD) == ETH_RECEIVEDTHRESHOLDCONTROL_32BYTES) || \
     ((THRESHOLD) == ETH_RECEIVEDTHRESHOLDCONTROL_96BYTES) || ((THRESHOLD) == ETH_RECEIVEDTHRESHOLDCONTROL_128BYTES))
...
#define IS_ETH_FIXED_BURST(CMD) (((CMD) == ETH_FIXEDBURST_ENABLE) || ((CMD) == ETH_FIXEDBURST_DISABLE))
#define IS_ETH_RXDMA_BURST_LENGTH(LENGTH)                                                                              \
    (((LENGTH) == ETH_RXDMABURSTLENGTH_1BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_2BEAT) ||                           \
     ((LENGTH) == ETH_RXDMABURSTLENGTH_4BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_8BEAT) ||                           \
     ((LENGTH) == ETH_RXDMABURSTLENGTH_16BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_32BEAT) ||                         \
     ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_4BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_8BEAT) ||               \
     ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_16BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_32BEAT) ||             \
     ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_64BEAT) || ((LENGTH) == ETH_RXDMABURSTLENGTH_4XPBL_128BEAT))
#define IS_ETH_TXDMA_BURST_LENGTH(LENGTH)                                                                              \
    (((LENGTH) == ETH_TXDMABURSTLENGTH_1BEAT) || ((LENGTH) == ETH_TXDMABURSTLENGTH_2BEAT) ||                           \
     ((LENGTH) == ETH_TXDMABURSTLENGTH_4BEAT) || ((LENGTH) == ETH_TXDMABURSTLENGTH_8BEAT) ||                           \
     ((LENGTH) == ETH_TXDMABURSTLENGTH_16BEAT) || ((LENGTH) == ETH_TXDMABURSTLENGTH_32BEAT) ||                         \
     ((LENGTH) == ETH_TXDMABURSTLENGTH_4XPBL_4BEAT) || ((LENGTH) == ETH_TXDMABURSTLENGTH_4XPBL_8BEAT) ||               \
...
#define IS_ETH_DMA_ARBITRATION_ROUNDROBIN_RXTX(RATIO)                                                                  \
    (((RATIO) == ETH_DMAARBITRATION_ROUNDROBIN_RXTX_1_1) || ((RATIO) == ETH_DMAARBITRATION_ROUNDROBIN_RXTX_2_1) ||     \
     ((RATIO) == ETH_DMAARBITRATION_ROUNDROBIN_RXTX_3_1) || ((RATIO) == ETH_DMAARBITRATION_ROUNDROBIN_RXTX_4_1) ||     \
     ((RATIO) == ETH_DMAARBITRATION_RXPRIORTX))
#define IS_ETH_DMATXDESC_GET_FLAG(FLAG)                                                                                \
    (((FLAG) == ETH_DMATXDESC_OWN) || ((FLAG) == ETH_DMATXDESC_IC) || ((FLAG) == ETH_DMATXDESC_LS) ||                  \
     ((FLAG) == ETH_DMATXDESC_FS) || ((FLAG) == ETH_DMATXDESC_DC) || ((FLAG) == ETH_DMATXDESC_DP) ||                   \
     ((FLAG) == ETH_DMATXDESC_TTSE) || ((FLAG) == ETH_DMATXDESC_TER) || ((FLAG) == ETH_DMATXDESC_TCH) ||               \
     ((FLAG) == ETH_DMATXDESC_TTSS) || ((FLAG) == ETH_DMATXDESC_IHE) || ((FLAG) == ETH_DMATXDESC_ES) ||                \
     ((FLAG) == ETH_DMATXDESC_JT) || ((FLAG) == ETH_DMATXDESC_FF) || ((FLAG) == ETH_DMATXDESC_PCE) ||                  \
     ((FLAG) == ETH_DMATXDESC_LCA) || ((FLAG) == ETH_DMATXDESC_NC) || ((FLAG) == ETH_DMATXDESC_LCO) ||                 \
     ((FLAG) == ETH_DMATXDESC_EC) || ((FLAG) == ETH_DMATXDESC_VF) || ((FLAG) == ETH_DMATXDESC_CC) ||                   \
     ((FLAG) == ETH_DMATXDESC_ED) || ((FLAG) == ETH_DMATXDESC_UF) || ((FLAG) == ETH_DMATXDESC_DB))
...
#define IS_ETH_DMA_TXDESC_CHECKSUM(CHECKSUM)                                                                           \
    (((CHECKSUM) == ETH_DMATXDESC_CHECKSUMBYPASS) || ((CHECKSUM) == ETH_DMATXDESC_CHECKSUMIPV4HEADER) ||               \
     ((CHECKSUM) == ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT) || ((CHECKSUM) == ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL))
#define IS_ETH_DMATXDESC_BUFFER_SIZE(SIZE) ((SIZE) <= 0x1FFFU)
#define IS_ETH_DMARXDESC_GET_FLAG(FLAG)                                                                                \
    (((FLAG) == ETH_DMARXDESC_OWN) || ((FLAG) == ETH_DMARXDESC_AFM) || ((FLAG) == ETH_DMARXDESC_ES) ||                 \
     ((FLAG) == ETH_DMARXDESC_DE) || ((FLAG) == ETH_DMARXDESC_SAF) || ((FLAG) == ETH_DMARXDESC_LE) ||                  \
     ((FLAG) == ETH_DMARXDESC_OE) || ((FLAG) == ETH_DMARXDESC_VLAN) || ((FLAG) == ETH_DMARXDESC_FS) ||                 \
     ((FLAG) == ETH_DMARXDESC_LS) || ((FLAG) == ETH_DMARXDESC_IPV4HCE) || ((FLAG) == ETH_DMARXDESC_LC) ||              \
     ((FLAG) == ETH_DMARXDESC_FT) || ((FLAG) == ETH_DMARXDESC_RWT) || ((FLAG) == ETH_DMARXDESC_RE) ||                  \
     ((FLAG) == ETH_DMARXDESC_DBE) || ((FLAG) == ETH_DMARXDESC_CE) || ((FLAG) == ETH_DMARXDESC_MAMPCE))
...
#define IS_ETH_DMA_GET_FLAG(FLAG)                                                                                      \
    (((FLAG) == ETH_DMA_FLAG_TST) || ((FLAG) == ETH_DMA_FLAG_PMT) || ((FLAG) == ETH_DMA_FLAG_MMC) ||                   \
     ((FLAG) == ETH_DMA_FLAG_DATATRANSFERERROR) || ((FLAG) == ETH_DMA_FLAG_READWRITEERROR) ||                          \
     ((FLAG) == ETH_DMA_FLAG_ACCESSERROR) || ((FLAG) == ETH_DMA_FLAG_NIS) || ((FLAG) == ETH_DMA_FLAG_AIS) ||           \
     ((FLAG) == ETH_DMA_FLAG_ER) || ((FLAG) == ETH_DMA_FLAG_FBE) || ((FLAG) == ETH_DMA_FLAG_ET) ||                     \
     ((FLAG) == ETH_DMA_FLAG_RWT) || ((FLAG) == ETH_DMA_FLAG_RPS) || ((FLAG) == ETH_DMA_FLAG_RBU) ||                   \
     ((FLAG) == ETH_DMA_FLAG_R) || ((FLAG) == ETH_DMA_FLAG_TU) || ((FLAG) == ETH_DMA_FLAG_RO) ||                       \
     ((FLAG) == ETH_DMA_FLAG_TJT) || ((FLAG) == ETH_DMA_FLAG_TBU) || ((FLAG) == ETH_DMA_FLAG_TPS) ||                   \
     ((FLAG) == ETH_DMA_FLAG_T))
#define IS_ETH_MAC_IT(IT) ((((IT)&0xFFFFFDF1U) == 0x00U) && ((IT) != 0x00U))
#define IS_ETH_MAC_GET_IT(IT)                                                                                          \
    (((IT) == ETH_MAC_IT_TST) || ((IT) == ETH_MAC_IT_MMCT) || ((IT) == ETH_MAC_IT_MMCR) || ((IT) == ETH_MAC_IT_MMC) || \
     ((IT) == ETH_MAC_IT_PMT))
#define IS_ETH_MAC_GET_FLAG(FLAG)                                                                                      \
    (((FLAG) == ETH_MAC_FLAG_TST) || ((FLAG) == ETH_MAC_FLAG_MMCT) || ((FLAG) == ETH_MAC_FLAG_MMCR) ||                 \
...
#define IS_ETH_DMA_GET_IT(IT)                                                                                          \
    (((IT) == ETH_DMA_IT_TST) || ((IT) == ETH_DMA_IT_PMT) || ((IT) == ETH_DMA_IT_MMC) || ((IT) == ETH_DMA_IT_NIS) ||   \
     ((IT) == ETH_DMA_IT_AIS) || ((IT) == ETH_DMA_IT_ER) || ((IT) == ETH_DMA_IT_FBE) || ((IT) == ETH_DMA_IT_ET) ||     \
     ((IT) == ETH_DMA_IT_RWT) || ((IT) == ETH_DMA_IT_RPS) || ((IT) == ETH_DMA_IT_RBU) || ((IT) == ETH_DMA_IT_R) ||     \
     ((IT) == ETH_DMA_IT_TU) || ((IT) == ETH_DMA_IT_RO) || ((IT) == ETH_DMA_IT_TJT) || ((IT) == ETH_DMA_IT_TBU) ||     \
...
#define IS_ETH_MMC_IT(IT) (((((IT)&0xFFDF3FFFU) == 0x00U) || (((IT)&0xEFFDFF9FU) == 0x00U)) && ((IT) != 0x00U))
#define IS_ETH_MMC_GET_IT(IT)                                                                                          \
    (((IT) == ETH_MMC_IT_TGF) || ((IT) == ETH_MMC_IT_TGFMSC) || ((IT) == ETH_MMC_IT_TGFSC) ||                          \
     ((IT) == ETH_MMC_IT_RGUF) || ((IT) == ETH_MMC_IT_RFAE) || ((IT) == ETH_MMC_IT_RFCE))
...
typedef struct {
    ...
    uint32_t PassControlFrames; /*!< Sets the forwarding mode of the control frames (including unicast and multicast
                                   PAUSE frames) This parameter can be a value of @ref ETH_Pass_Control_Frames */
    ...
    uint32_t MulticastFramesFilter; /*!< Selects the Multicast Frames filter mode:
                                       None/HashTableFilter/PerfectFilter/PerfectHashTableFilter. This parameter can be
                                       a value of @ref ETH_Multicast_Frames_Filter */
    ...
    uint32_t UnicastFramesFilter; /*!< Selects the Unicast Frames filter mode:
                                     ...
                                     of @ref ETH_Unicast_Frames_Filter */

    uint32_t
        HashTableHigh; /*!< This field holds the higher 32 bits of Hash table.
                                This parameter must be a number between Min_Data = 0x0 and Max_Data = 0xFFFFFFFFU */

    uint32_t HashTableLow; /*!< This field holds the lower 32 bits of Hash table.
                                    This parameter must be a number between Min_Data = 0x0 and Max_Data = 0xFFFFFFFFU */

    uint32_t PauseTime; /*!< This field holds the value to be used in the Pause Time field in the transmit control
                           frame. This parameter must be a number between Min_Data = 0x0 and Max_Data = 0xFFFFU */
...
typedef struct {
    ...
    uint32_t ForwardUndersizedGoodFrames; /*!< Enables or disables the Rx FIFO to forward Undersized frames (frames with
                                             no Error and length less than 64 bytes) including pad-bytes and CRC) This
                                             parameter can be a value of @ref ETH_Forward_Undersized_Good_Frames */
    ...
    uint32_t DescriptorSkipLength; /*!< Specifies the number of word to skip between two unchained descriptors (Ring
                                      mode) This parameter must be a number between Min_Data = 0 and Max_Data = 32 */
...
#define ETH_DMATXDESC_CIC_TCPUDPICMP_SEGMENT                                                                           \
    0x00800000U /*!< TCP/UDP/ICMP Checksum Insertion calculated over segment only */
...
#define ETH_DMATXDESC_ES                                                                                               \
    0x00008000U /*!< Error summary: OR of the following bits: UE || ED || EC || LCO || NC || LCA || FF || JT */
...
#define ETH_DMARXDESC_ES                                                                                               \
    0x00008000U /*!< Error summary: OR of the following bits: DE || OE || IPC || LC || RWT || RE || CE */
...
#define ETH_DMARXDESC_MAMPCE                                                                                           \
    0x00000001U /*!< Rx MAC Address/Payload Checksum Error: Rx MAC address matched/ Rx Payload Checksum Error */
...
#define ETH_RXDMABURSTLENGTH_1BEAT                                                                                     \
    0x00020000U /*!< maximum number of beats to be transferred in one RxDMA transaction is 1 */
#define ETH_RXDMABURSTLENGTH_2BEAT                                                                                     \
    0x00040000U /*!< maximum number of beats to be transferred in one RxDMA transaction is 2 */
#define ETH_RXDMABURSTLENGTH_4BEAT                                                                                     \
    0x00080000U /*!< maximum number of beats to be transferred in one RxDMA transaction is 4 */
#define ETH_RXDMABURSTLENGTH_8BEAT                                                                                     \
    0x00100000U /*!< maximum number of beats to be transferred in one RxDMA transaction is 8 */
...
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT                                                                        \
    0x00800000U /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be present */
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL                                                                           \
    0x00C00000U /*!< TCP/UDP/ICMP checksum fully in hardware including pseudo header */
/**
 * @}
 */
 ...
 * @retval None
 */
#define __HAL_ETH_DMARXDESC_ENABLE_IT(__HANDLE__)                                                                      \
    ((__HANDLE__)->RxDesc->ControlBufferSize &= (~(uint32_t)ETH_DMARXDESC_DIC))
 ...
 */
#define __HAL_ETH_DMATXDESC_GET_COLLISION_COUNT(__HANDLE__)                                                            \
    (((__HANDLE__)->TxDesc->Status & ETH_DMATXDESC_CC) >> ETH_DMATXDESC_COLLISION_COUNTSHIFT)
 ...
 *     @arg ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT : TCP/UDP/ICMP checksum. Pseudo header checksum is assumed to be
 * present
 *     @arg ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL : TCP/UDP/ICMP checksum fully in hardware including pseudo header
 * @retval None
 */
#define __HAL_ETH_DMATXDESC_CHECKSUM_INSERTION(__HANDLE__, __CHECKSUM__)                                               \
 ...
 */
#define __HAL_ETH_GET_FLOW_CONTROL_BUSY_STATUS(__HANDLE__)                                                             \
    (((__HANDLE__)->Instance->MACFCR & ETH_MACFCR_FCBBPA) == ETH_MACFCR_FCBBPA)
 ...
 */
#define __HAL_ETH_GET_DMA_OVERFLOW_STATUS(__HANDLE__, __OVERFLOW__)                                                    \
 ...
 * @retval None
 */
#define __HAL_ETH_MMC_COUNTER_FULL_PRESET(__HANDLE__)                                                                  \
    ((__HANDLE__)->Instance->MMCCR |= (ETH_MMCCR_MCFHP | ETH_MMCCR_MCP))
 ...
 * @retval None
 */
#define __HAL_ETH_MMC_RX_IT_ENABLE(__HANDLE__, __INTERRUPT__)                                                          \
 ...
 * @retval None
 */
#define __HAL_ETH_MMC_RX_IT_DISABLE(__HANDLE__, __INTERRUPT__)                                                         \
    (__HANDLE__)->Instance->MMCRIMR |= ((__INTERRUPT__)&0xEFFFFFFFU)
/**
...
HAL_StatusTypeDef HAL_ETH_DMATxDescListInit(ETH_HandleTypeDef *heth, ETH_DMADescTypeDef *DMATxDescTab, uint8_t *TxBuff,
                                            uint32_t TxBuffCount);
HAL_StatusTypeDef HAL_ETH_DMARxDescListInit(ETH_HandleTypeDef *heth, ETH_DMADescTypeDef *DMARxDescTab, uint8_t *RxBuff,
