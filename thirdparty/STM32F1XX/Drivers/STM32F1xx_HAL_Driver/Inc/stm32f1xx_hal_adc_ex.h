 ...
 *          - Scope injected group (affects all channels of injected group): InjectedNbrOfConversion,
 * InjectedDiscontinuousConvMode, AutoInjectedConv, ExternalTrigInjecConvEdge, ExternalTrigInjecConv.
 ...
 *          - For all except parameters 'ExternalTrigInjecConv': ADC enabled without conversion on going on injected
 * group.
 */
typedef struct {
    uint32_t
        InjectedChannel;           /*!< Selection of ADC channel to configure
                                      ...
                                      STM32F10xx8 and STM32F10xxB devices: A low-amplitude voltage glitch may be generated
                                      (on ADC input 0) on the PA0 pin, when the ADC is converting with injection trigger.      It
                                      is advised to distribute the analog channels so that Channel 0 is configured as an
                                      injected channel.      Refer to errata sheet of these devices for more details. */
    uint32_t InjectedRank;         /*!< Rank in the injected group sequencer
                                        This parameter must be a value of @ref ADCEx_injected_rank
                                        Note: In case of need to disable a channel or change order of conversion sequencer, rank
                                      containing a previous channel setting can be overwritten by the new channel setting (or
    ...
    uint32_t InjectedSamplingTime; /*!< Sampling time value to be set for the selected channel.
                                      ...
                                      clock cycles at ADC resolution 12 bits). This parameter can be a value of @ref
                                      ADC_sampling_times Caution: This parameter updates the parameter property of the
                                      channel, that can be used into regular and/or injected groups. If this same
                                      channel has been previously configured in the other group (regular/injected), it
                                      will be updated to last setting. Note: In case of usage of internal measurement
                                      channels (VrefInt/TempSensor), sampling time constraints must be respected
                                      (sampling time can be adjusted in function of ADC clock frequency and sampling
                                      time setting) Refer to device datasheet for timings values, parameters TS_vrefint,
                                      TS_temp (values rough order: 5us to 17.1us min). */
    uint32_t InjectedOffset; /*!< Defines the offset to be subtracted from the raw converted data (for channels set on
    ...
    uint32_t
        InjectedNbrOfConversion; /*!< Specifies the number of ranks that will be converted within the injected group
                                    sequencer. To use the injected group sequencer and convert several ranks, parameter
                                    'ScanConvMode' must be enabled. This parameter must be a number between Min_Data = 1
                                    and Max_Data = 4. Caution: this setting impacts the entire injected group.
                                    Therefore, call of HAL_ADCEx_InjectedConfigChannel() to configure a channel on
                                    injected group can impact the configuration of other channels previously set. */
    FunctionalState
        InjectedDiscontinuousConvMode; /*!< Specifies whether the conversions sequence of injected group is performed in
                                          ...
                                          disabled. If continuous mode is enabled, this parameter setting is discarded.
                                            ...
                                            Note: For injected group, number of discontinuous ranks increment is fixed
                                          to one-by-one. Caution: this setting impacts the entire injected group.
                                          Therefore, call of HAL_ADCEx_InjectedConfigChannel() to configure a channel on
                                          injected group can impact the configuration of other channels previously set.
                                        */
    FunctionalState
        AutoInjectedConv; /*!< Enables or disables the selected ADC automatic injected group conversion after regular
                             one This parameter can be set to ENABLE or DISABLE. Note: To use Automatic injected
                             conversion, discontinuous mode must be disabled ('DiscontinuousConvMode' and
                             'InjectedDiscontinuousConvMode' set to DISABLE) Note: To use Automatic injected conversion,
                             injected group external triggers must be disabled ('ExternalTrigInjecConv' set to
                             ADC_SOFTWARE_START) Note: In case of DMA used with regular group: if DMA configured in
                             normal mode (single shot) JAUTO will be stopped upon DMA transfer complete. To maintain
                             JAUTO always enabled, DMA must be configured in circular mode. Caution: this setting
                             impacts the entire injected group. Therefore, call of HAL_ADCEx_InjectedConfigChannel() to
                                        configure a channel on injected group can impact the configuration of other
                             channels previously set. */
    uint32_t
        ExternalTrigInjecConv; /*!< Selects the external event used to trigger the conversion start of injected group.
                                    If set to ADC_INJECTED_SOFTWARE_START, external triggers are disabled.
                                    If set to external trigger source, triggering is on event rising edge.
                                    This parameter can be a value of @ref ADCEx_External_trigger_source_Injected
                                    Note: This parameter must be modified when ADC is disabled (before ADC start
                                  conversion or after ADC stop conversion). If ADC is enabled, this parameter setting is
                                  bypassed without error reporting (as it can be the expected behaviour in case of
                                  another parameter update on the fly) Caution: this setting impacts the entire injected
                                  group. Therefore, call of HAL_ADCEx_InjectedConfigChannel() to configure a channel on
                                  injected group can impact the configuration of other channels previously set. */
} ADC_InjectionConfTypeDef;

#if defined(STM32F103x6) || defined(STM32F103xB) || defined(STM32F105xC) || defined(STM32F107xC) ||                    \
    defined(STM32F103xE) || defined(STM32F103xG)
/**
 * @brief  Structure definition of ADC multimode
 * @note   The setting of these parameters with function HAL_ADCEx_MultiModeConfigChannel() is conditioned to ADCs state
 * (both ADCs of the common group). State of ADCs of the common group must be: disabled.
 */
typedef struct {
    uint32_t
        Mode; /*!< Configures the ADC to operate in independent or multi mode.
                   This parameter can be a value of @ref ADCEx_Common_mode
                   Note: In dual mode, a change of channel configuration generates a restart that can produce a loss of
                 synchronization. It is recommended to disable dual mode before any configuration change. Note: In case
                 of simultaneous mode used: Exactly the same sampling time should be configured for the 2 channels that
                 will be sampled simultaneously by ACD1 and ADC2. Note: In case of interleaved mode used: To avoid
                 overlap between conversions, maximum sampling time allowed is 7 ADC clock cycles for fast interleaved
                 mode and 14 ADC clock cycles for slow interleaved mode. Note: Some multimode parameters are fixed on
                 STM32F1 and can be configured on other STM32 devices with several ADC (multimode configuration
                 structure can have additional parameters). The equivalences are:
                           - Parameter 'DMAAccessMode': On STM32F1, this parameter is fixed to 1 DMA channel (one DMA
                 channel for both ADC, DMA of ADC master). On other STM32 devices with several ADC, this is equivalent
                 to parameter 'ADC_DMAACCESSMODE_12_10_BITS'.
                           - Parameter 'TwoSamplingDelay': On STM32F1, this parameter is fixed to 7 or 14 ADC clock
                 cycles depending on fast or slow interleaved mode selected. On other STM32 devices with several ADC,
                 this is equivalent to parameter 'ADC_TWOSAMPLINGDELAY_7CYCLES' (for fast interleaved mode). */

} ADC_MultiModeTypeDef;
#endif /* defined STM32F103x6 || defined STM32F103xB || defined STM32F105xC || defined STM32F107xC || defined          \
          STM32F103xE || defined STM32F103xG */
...
#define ADC_DUALMODE_REGSIMULT_INJECSIMULT                                                                             \
    ((uint32_t)(ADC_CR1_DUALMOD_0)) /*!< ADC dual mode enabled: Combined regular simultaneous + injected simultaneous  \
                                       mode, on groups regular and injected */
#define ADC_DUALMODE_REGSIMULT_ALTERTRIG                                                                               \
    ((uint32_t)(ADC_CR1_DUALMOD_1)) /*!< ADC dual mode enabled: Combined regular simultaneous + alternate trigger      \
                                       mode, on groups regular and injected */
#define ADC_DUALMODE_INJECSIMULT_INTERLFAST                                                                            \
    ((uint32_t)(ADC_CR1_DUALMOD_1 |                                                                                    \
                ADC_CR1_DUALMOD_0)) /*!< ADC dual mode enabled: Combined injected simultaneous + fast interleaved      \
                                       mode, on groups regular and injected (delay between ADC sampling phases: 7 ADC  \
                                       clock cycles (equivalent to parameter "TwoSamplingDelay" set to                 \
                                       "ADC_TWOSAMPLINGDELAY_7CYCLES" on other STM32 devices)) */
#define ADC_DUALMODE_INJECSIMULT_INTERLSLOW                                                                            \
    ((uint32_t)(ADC_CR1_DUALMOD_2)) /*!< ADC dual mode enabled: Combined injected simultaneous + slow Interleaved      \
                                       mode, on groups regular and injected (delay between ADC sampling phases: 14 ADC \
                                       clock cycles (equivalent to parameter "TwoSamplingDelay" set to                 \
                                       "ADC_TWOSAMPLINGDELAY_7CYCLES" on other STM32 devices)) */
#define ADC_DUALMODE_INJECSIMULT                                                                                       \
    ((uint32_t)(ADC_CR1_DUALMOD_2 |                                                                                    \
                ADC_CR1_DUALMOD_0)) /*!< ADC dual mode enabled: Injected simultaneous mode, on group injected */
#define ADC_DUALMODE_REGSIMULT                                                                                         \
    ((uint32_t)(ADC_CR1_DUALMOD_2 |                                                                                    \
                ADC_CR1_DUALMOD_1)) /*!< ADC dual mode enabled: Regular simultaneous mode, on group regular */
#define ADC_DUALMODE_INTERLFAST                                                                                        \
    ((uint32_t)(ADC_CR1_DUALMOD_2 | ADC_CR1_DUALMOD_1 |                                                                \
                ADC_CR1_DUALMOD_0)) /*!< ADC dual mode enabled: Fast interleaved mode, on group regular (delay between \
                                       ADC sampling phases: 7 ADC clock cycles (equivalent to parameter                \
                                       "TwoSamplingDelay" set to "ADC_TWOSAMPLINGDELAY_7CYCLES" on other STM32         \
                                       devices)) */
#define ADC_DUALMODE_INTERLSLOW                                                                                        \
    ((uint32_t)(ADC_CR1_DUALMOD_3)) /*!< ADC dual mode enabled: Slow interleaved mode, on group regular (delay between \
                                       ADC sampling phases: 14 ADC clock cycles (equivalent to parameter               \
                                       "TwoSamplingDelay" set to "ADC_TWOSAMPLINGDELAY_7CYCLES" on other STM32         \
                                       devices)) */
#define ADC_DUALMODE_ALTERTRIG                                                                                         \
    ((uint32_t)(ADC_CR1_DUALMOD_3 |                                                                                    \
                ADC_CR1_DUALMOD_0)) /*!< ADC dual mode enabled: Alternate trigger mode, on group injected */
/**
 * @}
 */
#endif /* defined STM32F103x6 || defined STM32F103xB || defined STM32F105xC || defined STM32F107xC || defined          \
...
/** @defgroup ADCEx_Internal_HAL_driver_Ext_trig_src_Regular ADC Extended Internal HAL driver trigger selection for
 * regular group
 * @{
 */
...
/** @defgroup ADCEx_Internal_HAL_driver_Ext_trig_src_Injected ADC Extended Internal HAL driver trigger selection for
 * injected group
 * @{
 */
...
#define ADC_CFGR_EXTSEL(__HANDLE__, __EXT_TRIG_CONV__)                                                                 \
    (((((__HANDLE__)->Instance) == ADC3))                                                                              \
         ? (((__EXT_TRIG_CONV__) == ADC_EXTERNALTRIGCONV_T8_TRGO) ? (ADC3_EXTERNALTRIG_T8_TRGO) : (__EXT_TRIG_CONV__)) \
         : (__EXT_TRIG_CONV__))
#else
...
#define ADC_CFGR_JEXTSEL(__HANDLE__, __EXT_TRIG_INJECTCONV__)                                                          \
    (((((__HANDLE__)->Instance) == ADC3))                                                                              \
         ? (((__EXT_TRIG_INJECTCONV__) == ADC_EXTERNALTRIGINJECCONV_T8_CC4) ? (ADC3_EXTERNALTRIGINJEC_T8_CC4)          \
...
/**
 * @brief Verification if multimode is enabled for the selected ADC (multimode ADC master or ADC slave) (applicable for
...
#define ADC_MULTIMODE_IS_ENABLE(__HANDLE__)                                                                            \
    (((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC2)) ? (ADC1->CR1 & ADC_CR1_DUALMOD)        \
                                                                                : (RESET))
#else
...
/**
 * @brief Verification of condition for ADC start conversion: ADC must be in non-multimode, or multimode with handle of
 * ADC master (applicable for devices with several ADCs)
 * @param __HANDLE__: ADC handle
 * @retval None
 */
#if defined(STM32F103x6) || defined(STM32F103xB) || defined(STM32F105xC) || defined(STM32F107xC) ||                    \
...
/**
 * @brief Check ADC multimode setting: In case of multimode, check whether ADC master of the selected ADC has feature
 * auto-injection enabled (applicable for devices with several ADCs)
 * @param __HANDLE__: ADC handle
 * @retval None
 */
#if defined(STM32F103x6) || defined(STM32F103xB) || defined(STM32F105xC) || defined(STM32F107xC) ||                    \
...
#define IS_ADC_INJECTED_RANK(CHANNEL)                                                                                  \
    (((CHANNEL) == ADC_INJECTED_RANK_1) || ((CHANNEL) == ADC_INJECTED_RANK_2) || ((CHANNEL) == ADC_INJECTED_RANK_3) || \
...
#define IS_ADC_EXTTRIG(REGTRIG)                                                                                        \
    (((REGTRIG) == ADC_EXTERNALTRIGCONV_T1_CC1) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T1_CC2) ||                       \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T2_CC2) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T3_TRGO) ||                      \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T4_CC4) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_EXT_IT11) ||                     \
...
#define IS_ADC_EXTTRIG(REGTRIG)                                                                                        \
    (((REGTRIG) == ADC_EXTERNALTRIGCONV_T1_CC1) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T1_CC2) ||                       \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T2_CC2) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T3_TRGO) ||                      \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T4_CC4) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_EXT_IT11) ||                     \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T3_CC1) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T2_CC3) ||                       \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T8_CC1) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T5_CC1) ||                       \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T5_CC3) || ((REGTRIG) == ADC_EXTERNALTRIGCONV_T1_CC3) ||                       \
     ((REGTRIG) == ADC_EXTERNALTRIGCONV_T8_TRGO) || ((REGTRIG) == ADC_SOFTWARE_START))
#endif
...
#define IS_ADC_EXTTRIGINJEC(REGTRIG)                                                                                   \
    (((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_TRGO) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_CC1) ||            \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T3_CC4) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T4_TRGO) ||            \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_EXT_IT15) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T1_CC4) ||           \
...
#define IS_ADC_EXTTRIGINJEC(REGTRIG)                                                                                   \
    (((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_TRGO) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_CC1) ||            \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T3_CC4) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T4_TRGO) ||            \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_EXT_IT15) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T1_CC4) ||           \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T1_TRGO) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T8_CC4) ||            \
...
#define IS_ADC_EXTTRIGINJEC(REGTRIG)                                                                                   \
    (((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_TRGO) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T2_CC1) ||            \
     ...
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T4_CC3) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T8_CC2) ||             \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T5_TRGO) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T5_CC4) ||            \
     ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T1_CC4) || ((REGTRIG) == ADC_EXTERNALTRIGINJECCONV_T1_TRGO) ||            \
...
#define IS_ADC_MODE(MODE)                                                                                              \
    (((MODE) == ADC_MODE_INDEPENDENT) || ((MODE) == ADC_DUALMODE_REGSIMULT_INJECSIMULT) ||                             \
     ((MODE) == ADC_DUALMODE_REGSIMULT_ALTERTRIG) || ((MODE) == ADC_DUALMODE_INJECSIMULT_INTERLFAST) ||                \
     ((MODE) == ADC_DUALMODE_INJECSIMULT_INTERLSLOW) || ((MODE) == ADC_DUALMODE_INJECSIMULT) ||                        \
     ((MODE) == ADC_DUALMODE_REGSIMULT) || ((MODE) == ADC_DUALMODE_INTERLFAST) ||                                      \
