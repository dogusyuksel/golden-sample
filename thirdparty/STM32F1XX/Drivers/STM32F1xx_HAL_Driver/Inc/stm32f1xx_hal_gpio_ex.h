...
#define IS_AFIO_EVENTOUT_PIN(__PIN__)                                                                                  \
    (((__PIN__) == AFIO_EVENTOUT_PIN_0) || ((__PIN__) == AFIO_EVENTOUT_PIN_1) || ((__PIN__) == AFIO_EVENTOUT_PIN_2) || \
     ...
     ((__PIN__) == AFIO_EVENTOUT_PIN_9) || ((__PIN__) == AFIO_EVENTOUT_PIN_10) ||                                      \
     ((__PIN__) == AFIO_EVENTOUT_PIN_11) || ((__PIN__) == AFIO_EVENTOUT_PIN_12) ||                                     \
     ((__PIN__) == AFIO_EVENTOUT_PIN_13) || ((__PIN__) == AFIO_EVENTOUT_PIN_14) ||                                     \
...
#define IS_AFIO_EVENTOUT_PORT(__PORT__)                                                                                \
    (((__PORT__) == AFIO_EVENTOUT_PORT_A) || ((__PORT__) == AFIO_EVENTOUT_PORT_B) ||                                   \
     ((__PORT__) == AFIO_EVENTOUT_PORT_C) || ((__PORT__) == AFIO_EVENTOUT_PORT_D) ||                                   \
...
#define __HAL_AFIO_REMAP_USART3_ENABLE()                                                                               \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_USART3_REMAP_FULLREMAP, AFIO_MAPR_USART3_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_USART3_PARTIAL()                                                                              \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_USART3_REMAP_PARTIALREMAP, AFIO_MAPR_USART3_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_USART3_DISABLE()                                                                              \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_USART3_REMAP_NOREMAP, AFIO_MAPR_USART3_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM1_ENABLE()                                                                                 \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM1_REMAP_FULLREMAP, AFIO_MAPR_TIM1_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM1_PARTIAL()                                                                                \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM1_REMAP_PARTIALREMAP, AFIO_MAPR_TIM1_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM2_ENABLE()                                                                                 \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM2_REMAP_FULLREMAP, AFIO_MAPR_TIM2_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM2_PARTIAL_2()                                                                              \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2, AFIO_MAPR_TIM2_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM2_PARTIAL_1()                                                                              \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1, AFIO_MAPR_TIM2_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM3_ENABLE()                                                                                 \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM3_REMAP_FULLREMAP, AFIO_MAPR_TIM3_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM3_PARTIAL()                                                                                \
    AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM3_REMAP_PARTIALREMAP, AFIO_MAPR_TIM3_REMAP_FULLREMAP)
...
#define GPIO_GET_INDEX(__GPIOx__)                                                                                      \
    (((__GPIOx__) == (GPIOA)) ? 0uL : ((__GPIOx__) == (GPIOB)) ? 1uL : ((__GPIOx__) == (GPIOC)) ? 2uL : 3uL)
#elif defined(STM32F100xB) || defined(STM32F101xB) || defined(STM32F103xB) || defined(STM32F105xC) ||                  \
    defined(STM32F107xC)
#define GPIO_GET_INDEX(__GPIOx__)                                                                                      \
    (((__GPIOx__) == (GPIOA))   ? 0uL                                                                                  \
     : ((__GPIOx__) == (GPIOB)) ? 1uL                                                                                  \
     ...
     : ((__GPIOx__) == (GPIOD)) ? 3uL                                                                                  \
                                : 4uL)
#elif defined(STM32F100xE) || defined(STM32F101xE) || defined(STM32F101xG) || defined(STM32F103xE) ||                  \
    defined(STM32F103xG)
#define GPIO_GET_INDEX(__GPIOx__)                                                                                      \
    (((__GPIOx__) == (GPIOA))   ? 0uL                                                                                  \
     : ((__GPIOx__) == (GPIOB)) ? 1uL                                                                                  \
