...
#define IS_RTC_BKP(BKP)                                                                                                \
    (((BKP) <= (uint32_t)RTC_BKP_DR10) || (((BKP) >= (uint32_t)RTC_BKP_DR11) && ((BKP) <= (uint32_t)RTC_BKP_DR42)))
#else
 ...
 * @retval None
 */
#define __HAL_RTC_SECOND_GET_FLAG(__HANDLE__, __FLAG__)                                                                \
 ...
 * @retval None
 */
#define __HAL_RTC_OVERFLOW_GET_FLAG(__HANDLE__, __FLAG__)                                                              \
    (((((__HANDLE__)->Instance->CRL) & (__FLAG__)) != RESET) ? SET : RESET)
