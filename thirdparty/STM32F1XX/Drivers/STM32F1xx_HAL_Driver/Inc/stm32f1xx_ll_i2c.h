...
typedef struct {
    uint32_t
        PeripheralMode; /*!< Specifies the peripheral mode.
    ...
    uint32_t ClockSpeed; /*!< Specifies the clock frequency.
                            ...
                            LL_I2C_SetClockPeriod() or @ref LL_I2C_SetDutyCycle() or @ref LL_I2C_SetClockSpeedMode() or
                            @ref LL_I2C_ConfigSpeed(). */
    ...
    uint32_t
        TypeAcknowledge; /*!< Specifies the ACKnowledge or Non ACKnowledge condition after the address receive match
                            code or next received byte. This parameter can be a value of @ref I2C_LL_EC_I2C_ACKNOWLEDGE
...
#define LL_I2C_MODE_SMBUS_HOST                                                                                         \
    (uint32_t)(I2C_CR1_SMBUS | I2C_CR1_SMBTYPE | I2C_CR1_ENARP) /*!< SMBus Host address acknowledge */
...
#define __LL_I2C_RISE_TIME(__FREQRANGE__, __SPEED__)                                                                   \
    (uint32_t)(((__SPEED__) <= LL_I2C_MAX_SPEED_STANDARD) ? ((__FREQRANGE__) + 1U)                                     \
...
#define __LL_I2C_SPEED_FAST_TO_CCR(__PCLK__, __SPEED__, __DUTYCYCLE__)                                                 \
    (uint32_t)(                                                                                                        \
        ((__DUTYCYCLE__) == LL_I2C_DUTYCYCLE_2)                                                                        \
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_Enable(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_PE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_Disable(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_PE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableDMAReq_TX(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_DMAEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableDMAReq_TX(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_DMAEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableDMAReq_RX(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_DMAEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableDMAReq_RX(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_DMAEN); }
 ...
 */
__STATIC_INLINE uint32_t LL_I2C_DMA_GetRegAddr(I2C_TypeDef *I2Cx) { return (uint32_t) & (I2Cx->DR); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableClockStretching(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_NOSTRETCH); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableClockStretching(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_NOSTRETCH); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableGeneralCall(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_ENGC); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableGeneralCall(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_ENGC); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableOwnAddress2(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->OAR2, I2C_OAR2_ENDUAL); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableOwnAddress2(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->OAR2, I2C_OAR2_ENDUAL); }
 ...
 * @param  I2Cx I2C Instance.
 * @param  ClockPeriod This parameter must be a value between Min_Data=0x004 and Max_Data=0xFFF, except in FAST DUTY
 * mode where Min_Data=0x001.
 * @retval None
 */
...
__STATIC_INLINE void LL_I2C_ConfigSpeed(I2C_TypeDef *I2Cx, uint32_t PeriphClock, uint32_t ClockSpeed,
    ...
    if (ClockSpeed > LL_I2C_MAX_SPEED_STANDARD) {
        ...
        clockconfig =
            LL_I2C_CLOCK_SPEED_FAST_MODE | __LL_I2C_SPEED_FAST_TO_CCR(PeriphClock, ClockSpeed, DutyCycle) | DutyCycle;
    } else {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableSMBusAlert(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_ALERT); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableSMBusAlert(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_ALERT); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableSMBusPEC(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_ENPEC); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableSMBusPEC(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_ENPEC); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableIT_TX(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN | I2C_CR2_ITBUFEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableIT_TX(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN | I2C_CR2_ITBUFEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableIT_RX(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN | I2C_CR2_ITBUFEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableIT_RX(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN | I2C_CR2_ITBUFEN); }
 ...
 *
 * @note   Any of these events will generate interrupt if Buffer interrupts are enabled too(using unitary function @ref
 * LL_I2C_EnableIT_BUF()) : Receive buffer not empty (RXNE) Transmit buffer empty (TXE)
 * @rmtoll CR2          ITEVTEN       LL_I2C_EnableIT_EVT
 * @param  I2Cx I2C Instance.
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableIT_EVT(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableIT_EVT(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_ITEVTEN); }
 ...
 * @note   Any of these Buffer events will generate interrupt if Events interrupts are enabled too(using unitary
 * function @ref LL_I2C_EnableIT_EVT()) : Receive buffer not empty (RXNE) Transmit buffer empty (TXE)
 * @rmtoll CR2          ITBUFEN       LL_I2C_EnableIT_BUF
 * @param  I2Cx I2C Instance.
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableIT_BUF(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_ITBUFEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableIT_BUF(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_ITBUFEN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableIT_ERR(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_ITERREN); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableIT_ERR(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_ITERREN); }
 ...
 *         SET: When the address is fully sent (master mode) or when the received slave address matched with one of the
 * enabled slave address (slave mode).
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearFlag_AF(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_AF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearFlag_BERR(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_BERR); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearFlag_ARLO(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_ARLO); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearFlag_OVR(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_OVR); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_PECERR(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_PECERR); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_TIMEOUT(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_TIMEOUT); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_ClearSMBusFlag_ALERT(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->SR1, I2C_SR1_SMBALERT); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableReset(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_SWRST); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableReset(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_SWRST); }
...
/**
 * @brief  Prepare the generation of a ACKnowledge or Non ACKnowledge condition after the address receive match code or
 * next received byte.
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_GenerateStartCondition(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_START); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_GenerateStopCondition(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_STOP); }

/**
 * @brief  Enable bit POS (master/host mode).
 * @note   In that case, the ACK bit controls the (N)ACK of the next byte received or the PEC bit indicates that the
 * next byte in shift register is a PEC.
 * @rmtoll CR1          POS           LL_I2C_EnableBitPOS
 * @param  I2Cx I2C Instance.
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableBitPOS(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_POS); }

/**
 * @brief  Disable bit POS (master/host mode).
 * @note   In that case, the ACK bit controls the (N)ACK of the current byte received or the PEC bit indicates that the
 * current byte in shift register is a PEC.
 * @rmtoll CR1          POS           LL_I2C_DisableBitPOS
 * @param  I2Cx I2C Instance.
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableBitPOS(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_POS); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableLastDMA(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR2, I2C_CR2_LAST); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableLastDMA(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR2, I2C_CR2_LAST); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_EnableSMBusPECCompare(I2C_TypeDef *I2Cx) { SET_BIT(I2Cx->CR1, I2C_CR1_PEC); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_DisableSMBusPECCompare(I2C_TypeDef *I2Cx) { CLEAR_BIT(I2Cx->CR1, I2C_CR1_PEC); }
 ...
 */
__STATIC_INLINE uint8_t LL_I2C_ReceiveData8(I2C_TypeDef *I2Cx) { return (uint8_t)(READ_BIT(I2Cx->DR, I2C_DR_DR)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2C_TransmitData8(I2C_TypeDef *I2Cx, uint8_t Data) { MODIFY_REG(I2Cx->DR, I2C_DR_DR, Data); }
