 ...
 * @{
 */
#define LL_RTC_TAMPER_ACTIVELEVEL_LOW                                                                                  \
    BKP_CR_TPAL /*!< A high level on the TAMPER pin resets all data backup registers (if TPE bit is set) */
#define LL_RTC_TAMPER_ACTIVELEVEL_HIGH                                                                                 \
    (0x00000000U) /*!< A low level on the TAMPER pin resets all data backup registers (if TPE bit is set) */
...
#define LL_RTC_CALIB_OUTPUT_RTCCLOCK                                                                                   \
    BKP_RTCCR_CCO /*!< Calibration output is RTC Clock with a frequency divided by 64 on the TAMPER Pin */
#define LL_RTC_CALIB_OUTPUT_ALARM BKP_RTCCR_ASOE /*!< Calibration output is Alarm pulse signal on the TAMPER pin */
#define LL_RTC_CALIB_OUTPUT_SECOND                                                                                     \
    (BKP_RTCCR_ASOS | BKP_RTCCR_ASOE) /*!< Calibration output is Second pulse signal on the TAMPER pin*/
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableWriteProtection(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRL, RTC_CRL_CNF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableWriteProtection(RTC_TypeDef *RTCx) { SET_BIT(RTCx->CRL, RTC_CRL_CNF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_TAMPER_Enable(BKP_TypeDef *BKPx) { SET_BIT(BKPx->CR, BKP_CR_TPE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_TAMPER_Disable(BKP_TypeDef *BKPx) { CLEAR_BIT(BKP->CR, BKP_CR_TPE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMPI(BKP_TypeDef *BKPx) { SET_BIT(BKPx->CSR, BKP_CSR_CTI); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_TAMPE(BKP_TypeDef *BKPx) { SET_BIT(BKPx->CSR, BKP_CSR_CTE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_ALR(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRL, RTC_CRL_ALRF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_RS(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRL, RTC_CRL_RSF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_OW(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRL, RTC_CRL_OWF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_ClearFlag_SEC(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRL, RTC_CRL_SECF); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_ALR(RTC_TypeDef *RTCx) { SET_BIT(RTCx->CRH, RTC_CRH_ALRIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_ALR(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRH, RTC_CRH_ALRIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_SEC(RTC_TypeDef *RTCx) { SET_BIT(RTCx->CRH, RTC_CRH_SECIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_SEC(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRH, RTC_CRH_SECIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_OW(RTC_TypeDef *RTCx) { SET_BIT(RTCx->CRH, RTC_CRH_OWIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_OW(RTC_TypeDef *RTCx) { CLEAR_BIT(RTCx->CRH, RTC_CRH_OWIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_EnableIT_TAMP(BKP_TypeDef *BKPx) { SET_BIT(BKPx->CSR, BKP_CSR_TPIE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RTC_DisableIT_TAMP(BKP_TypeDef *BKPx) { CLEAR_BIT(BKPx->CSR, BKP_CSR_TPIE); }
