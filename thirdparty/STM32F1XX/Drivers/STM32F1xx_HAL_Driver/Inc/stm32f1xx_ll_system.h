...
#define LL_DBGMCU_TRACE_SYNCH_SIZE1                                                                                    \
    (DBGMCU_CR_TRACE_IOEN |                                                                                            \
     DBGMCU_CR_TRACE_MODE_0) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size of 1 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE2                                                                                    \
    (DBGMCU_CR_TRACE_IOEN |                                                                                            \
     DBGMCU_CR_TRACE_MODE_1) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size of 2 */
#define LL_DBGMCU_TRACE_SYNCH_SIZE4                                                                                    \
    (DBGMCU_CR_TRACE_IOEN |                                                                                            \
     DBGMCU_CR_TRACE_MODE) /*!< TRACE pin assignment for Synchronous Mode with a TRACEDATA size of 4 */
/**
 * @}
 */
...
#define LL_DBGMCU_APB1_GRP1_I2C1_STOP                                                                                  \
    DBGMCU_CR_DBG_I2C1_SMBUS_TIMEOUT /*!< I2C1 SMBUS timeout mode stopped when Core is halted */
#if defined(DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT)
#define LL_DBGMCU_APB1_GRP1_I2C2_STOP                                                                                  \
    DBGMCU_CR_DBG_I2C2_SMBUS_TIMEOUT /*!< I2C2 SMBUS timeout mode stopped when Core is halted */
...
/**
  ...
  * @note This field indicates the revision of the device.
          ...
          For example, it is read as revA -> 0x0000, revB -> 0x2000, revZ -> 0x2001, rev1,2,3,X or Y -> 0x2003,for
  Medium Density devices For example, it is read as revA or 1 -> 0x1000, revZ -> 0x1001,rev1,2,3,X or Y -> 0x1003,for
  Medium Density devices For example, it is read as revA or 1 -> 0x1003,for XL Density devices For example, it is read
  as revA -> 0x1000, revZ -> 0x1001 for  Connectivity line devices
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_EnableDBGSleepMode(void) { SET_BIT(DBGMCU->CR, DBGMCU_CR_DBG_SLEEP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_DisableDBGSleepMode(void) { CLEAR_BIT(DBGMCU->CR, DBGMCU_CR_DBG_SLEEP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_EnableDBGStopMode(void) { SET_BIT(DBGMCU->CR, DBGMCU_CR_DBG_STOP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_DisableDBGStopMode(void) { CLEAR_BIT(DBGMCU->CR, DBGMCU_CR_DBG_STOP); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_EnableDBGStandbyMode(void) { SET_BIT(DBGMCU->CR, DBGMCU_CR_DBG_STANDBY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_DisableDBGStandbyMode(void) { CLEAR_BIT(DBGMCU->CR, DBGMCU_CR_DBG_STANDBY); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_APB1_GRP1_FreezePeriph(uint32_t Periphs) { SET_BIT(DBGMCU->CR, Periphs); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_APB1_GRP1_UnFreezePeriph(uint32_t Periphs) { CLEAR_BIT(DBGMCU->CR, Periphs); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_APB2_GRP1_FreezePeriph(uint32_t Periphs) { SET_BIT(DBGMCU->CR, Periphs); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DBGMCU_APB2_GRP1_UnFreezePeriph(uint32_t Periphs) { CLEAR_BIT(DBGMCU->CR, Periphs); }
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_SetLatency(uint32_t Latency) { MODIFY_REG(FLASH->ACR, FLASH_ACR_LATENCY, Latency); }
 ...
 *         @arg @ref LL_FLASH_LATENCY_2
 */
__STATIC_INLINE uint32_t LL_FLASH_GetLatency(void) { return (uint32_t)(READ_BIT(FLASH->ACR, FLASH_ACR_LATENCY)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_EnablePrefetch(void) { SET_BIT(FLASH->ACR, FLASH_ACR_PRFTBE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_DisablePrefetch(void) { CLEAR_BIT(FLASH->ACR, FLASH_ACR_PRFTBE); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_EnableHalfCycleAccess(void) { SET_BIT(FLASH->ACR, FLASH_ACR_HLFCYA); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_FLASH_DisableHalfCycleAccess(void) { CLEAR_BIT(FLASH->ACR, FLASH_ACR_HLFCYA); }
