...
#define ADC_INJ_JOFRX_REGOFFSET_MASK                                                                                   \
    (ADC_JOFR1_REGOFFSET | ADC_JOFR2_REGOFFSET | ADC_JOFR3_REGOFFSET | ADC_JOFR4_REGOFFSET)
...
#define ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0                                                                             \
    0x0000001FU /* Equivalent to shift: (ADC_CHANNEL_NUMBER_MASK >> POSITION_VAL(ADC_CHANNEL_NUMBER_MASK)) */

/* Channel differentiation between external and internal channels */
#define ADC_CHANNEL_ID_INTERNAL_CH 0x80000000U /* Marker of internal channel */
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                                                                   \
    0x40000000U /* Marker of internal channel for other ADC instances, in case of different ADC internal channels      \
                   mapped on same channel number on different ADC instances */
...
#define ADC_CHANNEL_0_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((0U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP0) */
#define ADC_CHANNEL_1_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((3U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP1) */
#define ADC_CHANNEL_2_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((6U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP2) */
#define ADC_CHANNEL_3_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((9U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP3) */
#define ADC_CHANNEL_4_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((12U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP4) */
#define ADC_CHANNEL_5_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((15U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP5) */
#define ADC_CHANNEL_6_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((18U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP6) */
#define ADC_CHANNEL_7_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((21U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP7) */
#define ADC_CHANNEL_8_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((24U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP8) */
#define ADC_CHANNEL_9_SMP                                                                                              \
    (ADC_SMPR2_REGOFFSET |                                                                                             \
     ((27U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR2_SMP9) */
#define ADC_CHANNEL_10_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((0U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP10) */
#define ADC_CHANNEL_11_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((3U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP11) */
#define ADC_CHANNEL_12_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((6U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP12) */
#define ADC_CHANNEL_13_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((9U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP13) */
#define ADC_CHANNEL_14_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((12U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP14) */
#define ADC_CHANNEL_15_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((15U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP15) */
#define ADC_CHANNEL_16_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((18U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP16) */
#define ADC_CHANNEL_17_SMP                                                                                             \
    (ADC_SMPR1_REGOFFSET |                                                                                             \
     ((21U) << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to POSITION_VAL(ADC_SMPR1_SMP17) */
...
typedef struct {
    uint32_t
        Multimode; /*!< Set ADC multimode configuration to operate in independent mode or multimode (for devices with
                      several ADC instances). This parameter can be a value of @ref ADC_LL_EC_MULTI_MODE
 ...
 */
typedef struct {
    uint32_t TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW start) or from external
                               IP (timer event, external interrupt line). This parameter can be a value of @ref
    ...
    uint32_t SequencerDiscont; /*!< Set ADC group regular sequencer discontinuous mode: sequence subdivided and scan
                                  conversions interrupted every selected number of ranks. This parameter can be a value
                                  of @ref ADC_LL_EC_REG_SEQ_DISCONT_MODE
    ...
    uint32_t ContinuousMode; /*!< Set ADC continuous conversion mode on ADC group regular, whether ADC conversions are
                                performed in single mode (one conversion per trigger) or in continuous mode (after the
                                first trigger, following conversions launched successively automatically). This
                                parameter can be a value of @ref ADC_LL_EC_REG_CONTINUOUS_MODE Note: It is not possible
                                to enable both ADC group regular continuous mode and discontinuous mode.

                                  This feature can be modified afterwards using unitary function @ref
                                LL_ADC_REG_SetContinuousMode(). */

    uint32_t DMATransfer; /*!< Set ADC group regular conversion data transfer: no transfer or transfer by DMA, and DMA
                             requests mode. This parameter can be a value of @ref ADC_LL_EC_REG_DMA_TRANSFER
 ...
 */
typedef struct {
    uint32_t TriggerSource; /*!< Set ADC group injected conversion trigger source: internal (SW start) or from external
                               IP (timer event, external interrupt line). This parameter can be a value of @ref
    ...
    uint32_t SequencerDiscont; /*!< Set ADC group injected sequencer discontinuous mode: sequence subdivided and scan
                                  conversions interrupted every selected number of ranks. This parameter can be a value
                                  of @ref ADC_LL_EC_INJ_SEQ_DISCONT_MODE
    ...
    uint32_t
        TrigAuto; /*!< Set ADC group injected conversion trigger: independent or from ADC group regular.
                       This parameter can be a value of @ref ADC_LL_EC_INJ_TRIG_AUTO
                       Note: This parameter must be set to set to independent trigger if injected trigger source is set
...
#define LL_ADC_FLAG_EOS                                                                                                \
    ADC_SR_EOC /*!< ADC flag ADC group regular end of sequence conversions (Note: on this STM32 series, there is no    \
                  flag ADC group regular end of unitary conversion. Flag noted as "EOC" is corresponding to flag "EOS" \
                  in other STM32 families) */
#define LL_ADC_FLAG_JSTRT ADC_SR_JSTRT /*!< ADC flag ADC group injected conversion start */
#define LL_ADC_FLAG_JEOS                                                                                               \
    ADC_SR_JEOC /*!< ADC flag ADC group injected end of sequence conversions (Note: on this STM32 series, there is no  \
                   flag ADC group injected end of unitary conversion. Flag noted as "JEOC" is corresponding to flag    \
                   "JEOS" in other STM32 families) */
#define LL_ADC_FLAG_AWD1 ADC_SR_AWD /*!< ADC flag ADC analog watchdog 1 */
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_FLAG_EOS_MST                                                                                            \
    ADC_SR_EOC /*!< ADC flag ADC multimode master group regular end of sequence conversions (Note: on this STM32       \
                  series, there is no flag ADC group regular end of unitary conversion. Flag noted as "EOC" is         \
                  corresponding to flag "EOS" in other STM32 families) */
#define LL_ADC_FLAG_EOS_SLV                                                                                            \
    ADC_SR_EOC /*!< ADC flag ADC multimode slave group regular end of sequence conversions (Note: on this STM32        \
                  series, there is no flag ADC group regular end of unitary conversion. Flag noted as "EOC" is         \
                  corresponding to flag "EOS" in other STM32 families) (on STM32F1, this flag must be read from ADC    \
                  instance slave: ADC2) */
#define LL_ADC_FLAG_JEOS_MST                                                                                           \
    ADC_SR_JEOC /*!< ADC flag ADC multimode master group injected end of sequence conversions (Note: on this STM32     \
                   series, there is no flag ADC group injected end of unitary conversion. Flag noted as "JEOC" is      \
                   corresponding to flag "JEOS" in other STM32 families) */
#define LL_ADC_FLAG_JEOS_SLV                                                                                           \
    ADC_SR_JEOC /*!< ADC flag ADC multimode slave group injected end of sequence conversions (Note: on this STM32      \
                   series, there is no flag ADC group injected end of unitary conversion. Flag noted as "JEOC" is      \
                   corresponding to flag "JEOS" in other STM32 families) (on STM32F1, this flag must be read from ADC  \
                   instance slave: ADC2) */
...
#define LL_ADC_FLAG_AWD1_SLV                                                                                           \
    ADC_SR_AWD /*!< ADC flag ADC multimode slave analog watchdog 1 of the ADC slave (on STM32F1, this flag must be     \
                  read from ADC instance slave: ADC2) */
#endif
/**
 * @}
 */
...
#define LL_ADC_IT_EOS                                                                                                  \
    ADC_CR1_EOCIE /*!< ADC interruption ADC group regular end of sequence conversions (Note: on this STM32 series,     \
                     there is no flag ADC group regular end of unitary conversion. Flag noted as "EOC" is              \
                     corresponding to flag "EOS" in other STM32 families) */
#define LL_ADC_IT_JEOS                                                                                                 \
    ADC_CR1_JEOCIE /*!< ADC interruption ADC group injected end of sequence conversions (Note: on this STM32 series,   \
                      there is no flag ADC group injected end of unitary conversion. Flag noted as "JEOC" is           \
                      corresponding to flag "JEOS" in other STM32 families) */
...
#define LL_ADC_DMA_REG_REGULAR_DATA                                                                                    \
    0x00000000U /* ADC group regular conversion data register (corresponding to register DR) to be used with ADC       \
                   configured in independent mode. Without DMA transfer, register accessed by LL function @ref         \
                   LL_ADC_REG_ReadConversionData32() and other functions @ref LL_ADC_REG_ReadConversionDatax() */
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                                                              \
    0x00000001U /* ADC group regular conversion data register (corresponding to register CDR) to be used with ADC      \
                   configured in multimode (available on STM32 devices with several ADC instances). Without DMA        \
                   transfer, register accessed by LL function @ref LL_ADC_REG_ReadMultiConversionData32() */
#endif
/**
 * @}
 */
...
#define LL_ADC_PATH_INTERNAL_TEMPSENSOR                                                                                \
    (ADC_CR2_TSVREFE) /*!< ADC measurement path to internal channel temperature sensor */
/**
 * @}
 */
...
#define LL_ADC_DATA_ALIGN_RIGHT                                                                                        \
    0x00000000U /*!< ADC conversion data alignment: right aligned (alignment on data register LSB bit 0)*/
#define LL_ADC_DATA_ALIGN_LEFT                                                                                         \
    (ADC_CR2_ALIGN) /*!< ADC conversion data alignment: left aligned (alignment on data register MSB bit 15)*/
/**
 * @}
 */
...
#define LL_ADC_SEQ_SCAN_DISABLE                                                                                        \
    0x00000000U /*!< ADC conversion is performed in unitary conversion mode (one channel converted, that defined in    \
                   rank 1). Configuration of both groups regular and injected sequencers (sequence length, ...) is     \
                   discarded: equivalent to length of 1 rank.*/
#define LL_ADC_SEQ_SCAN_ENABLE                                                                                         \
    (ADC_CR1_SCAN) /*!< ADC conversions are performed in sequence conversions mode, according to configuration of both \
                      groups regular and injected sequencers (sequence length, ...). */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_0                                                                                               \
    (ADC_CHANNEL_0_NUMBER | ADC_CHANNEL_0_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN0  */
#define LL_ADC_CHANNEL_1                                                                                               \
    (ADC_CHANNEL_1_NUMBER | ADC_CHANNEL_1_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN1  */
#define LL_ADC_CHANNEL_2                                                                                               \
    (ADC_CHANNEL_2_NUMBER | ADC_CHANNEL_2_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN2  */
#define LL_ADC_CHANNEL_3                                                                                               \
    (ADC_CHANNEL_3_NUMBER | ADC_CHANNEL_3_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN3  */
#define LL_ADC_CHANNEL_4                                                                                               \
    (ADC_CHANNEL_4_NUMBER | ADC_CHANNEL_4_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN4  */
#define LL_ADC_CHANNEL_5                                                                                               \
    (ADC_CHANNEL_5_NUMBER | ADC_CHANNEL_5_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN5  */
#define LL_ADC_CHANNEL_6                                                                                               \
    (ADC_CHANNEL_6_NUMBER | ADC_CHANNEL_6_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN6  */
#define LL_ADC_CHANNEL_7                                                                                               \
    (ADC_CHANNEL_7_NUMBER | ADC_CHANNEL_7_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN7  */
#define LL_ADC_CHANNEL_8                                                                                               \
    (ADC_CHANNEL_8_NUMBER | ADC_CHANNEL_8_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN8  */
#define LL_ADC_CHANNEL_9                                                                                               \
    (ADC_CHANNEL_9_NUMBER | ADC_CHANNEL_9_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN9  */
#define LL_ADC_CHANNEL_10                                                                                              \
    (ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN10   \
                                                  */
#define LL_ADC_CHANNEL_11                                                                                              \
    (ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN11   \
                                                  */
#define LL_ADC_CHANNEL_12                                                                                              \
    (ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN12   \
                                                  */
#define LL_ADC_CHANNEL_13                                                                                              \
    (ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN13   \
                                                  */
#define LL_ADC_CHANNEL_14                                                                                              \
    (ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN14   \
                                                  */
#define LL_ADC_CHANNEL_15                                                                                              \
    (ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN15   \
                                                  */
#define LL_ADC_CHANNEL_16                                                                                              \
    (ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN16   \
                                                  */
#define LL_ADC_CHANNEL_17                                                                                              \
    (ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP) /*!< ADC external channel (channel connected to GPIO pin) ADCx_IN17   \
                                                  */
#define LL_ADC_CHANNEL_VREFINT                                                                                         \
    (LL_ADC_CHANNEL_17 |                                                                                               \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal voltage reference. On        \
                                    STM32F1, ADC channel available only on ADC instance: ADC1. */
 ...
 * @{
 */
/* ADC group regular external triggers for ADC instances: ADC1, ADC2, ADC3 (for ADC instances ADCx available on the
 * selected device) */
#define LL_ADC_REG_TRIG_SOFTWARE                                                                                       \
    (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1 |                                                                             \
     ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger internal: SW start. */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                                                                   \
    (ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger from external IP: TIM1 channel 3 event (capture       \
                          compare: input capture or output capture). Trigger edge set to rising edge (default          \
                          setting). */
/* ADC group regular external triggers for ADC instances: ADC1, ADC2 (for ADC instances ADCx available on the selected
 * device) */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                                                                   \
    0x00000000U /*!< ADC group regular conversion trigger from external IP: TIM1 channel 1 event (capture compare:     \
                   input capture or output capture). Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                                                                   \
    (ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM1 channel 2 event (capture       \
                          compare: input capture or output capture). Trigger edge set to rising edge (default          \
                          setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                                                   \
    (ADC_CR2_EXTSEL_1 | ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM2 channel 2   \
                                             event (capture compare: input capture or output capture). Trigger edge    \
                                             set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                                                                  \
    (ADC_CR2_EXTSEL_2) /*!< ADC group regular conversion trigger from external IP: TIM3 TRGO. Trigger edge set to      \
                          rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                                                                   \
    (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM4 channel 4   \
                                             event (capture compare: input capture or output capture). Trigger edge    \
                                             set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                                                \
    (ADC_CR2_EXTSEL_2 | ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger from external IP: external         \
                                             interrupt line 11. Trigger edge set to rising edge (default setting). */
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                                                                  \
    (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger from external IP: TIM8 TRGO. Trigger   \
                                         edge set to rising edge (default setting). Available only on high-density and \
                                         XL-density devices. A remap of trigger must be done at top level (refer to    \
                                         AFIO peripheral).*/
...
#define LL_ADC_REG_TRIG_EXT_TIM3_CH1                                                                                   \
    (LL_ADC_REG_TRIG_EXT_TIM1_CH1) /*!< ADC group regular conversion trigger from external IP: TIM3 channel 1 event    \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH3                                                                                   \
    (LL_ADC_REG_TRIG_EXT_TIM1_CH2) /*!< ADC group regular conversion trigger from external IP: TIM2 channel 3 event    \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_CH1                                                                                   \
    (LL_ADC_REG_TRIG_EXT_TIM2_CH2) /*!< ADC group regular conversion trigger from external IP: TIM8 channel 1 event    \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO_ADC3                                                                             \
    (LL_ADC_REG_TRIG_EXT_TIM3_TRGO) /*!< ADC group regular conversion trigger from external IP: TIM8 TRGO. Trigger     \
                                       edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH1                                                                                   \
    (LL_ADC_REG_TRIG_EXT_TIM4_CH4) /*!< ADC group regular conversion trigger from external IP: TIM5 channel 1 event    \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH3                                                                                   \
    (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger from external IP: TIM5 channel 3 event \
                                         (capture compare: input capture or output capture). Trigger edge set to       \
                                         rising edge (default setting). */
#endif
/**
 * @}
...
#define LL_ADC_REG_TRIG_EXT_RISING                                                                                     \
    ADC_CR2_EXTTRIG /*!< ADC group regular conversion trigger polarity set to rising edge */
/**
 * @}
 */
...
#define LL_ADC_REG_CONV_SINGLE                                                                                         \
    0x00000000U /*!< ADC conversions are performed in single mode: one conversion per trigger */
#define LL_ADC_REG_CONV_CONTINUOUS                                                                                     \
    (ADC_CR2_CONT) /*!< ADC conversions are performed in continuous mode: after the first trigger, following           \
...
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                                                              \
    (ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in unlimited mode: DMA transfer requests are        \
                     unlimited, whatever number of DMA data transferred (number of ADC conversions). This ADC mode is  \
                     intended to be used with DMA mode circular. */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_SCAN_DISABLE                                                                                    \
    0x00000000U /*!< ADC group regular sequencer disable (equivalent to sequencer of 1 rank: ADC conversion on only 1  \
                   channel) */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_2RANKS                                                                              \
    (ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 2 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_3RANKS                                                                              \
    (ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 3 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_4RANKS                                                                              \
    (ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 4 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_5RANKS                                                                              \
    (ADC_SQR1_L_2) /*!< ADC group regular sequencer enable with 5 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_6RANKS                                                                              \
    (ADC_SQR1_L_2 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 6 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_7RANKS                                                                              \
    (ADC_SQR1_L_2 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 7 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_8RANKS                                                                              \
    (ADC_SQR1_L_2 | ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 8 ranks in the sequence  \
                                                  */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_9RANKS                                                                              \
    (ADC_SQR1_L_3) /*!< ADC group regular sequencer enable with 9 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_10RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 10 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_11RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 11 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_12RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_1 |                                                                                     \
     ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 12 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_13RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_2) /*!< ADC group regular sequencer enable with 13 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_14RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_2 |                                                                                     \
     ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 14 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_15RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_2 |                                                                                     \
     ADC_SQR1_L_1) /*!< ADC group regular sequencer enable with 15 ranks in the sequence */
#define LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS                                                                             \
    (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1 |                                                                      \
     ADC_SQR1_L_0) /*!< ADC group regular sequencer enable with 16 ranks in the sequence */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_DISCONT_1RANK                                                                                   \
    (ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence interruption every rank  \
                      */
#define LL_ADC_REG_SEQ_DISCONT_2RANKS                                                                                  \
    (ADC_CR1_DISCNUM_0 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enabled with sequence     \
                                            interruption every 2 ranks */
#define LL_ADC_REG_SEQ_DISCONT_3RANKS                                                                                  \
    (ADC_CR1_DISCNUM_1 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence      \
                                            interruption every 3 ranks */
#define LL_ADC_REG_SEQ_DISCONT_4RANKS                                                                                  \
    (ADC_CR1_DISCNUM_1 | ADC_CR1_DISCNUM_0 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode       \
                                                                enable with sequence interruption every 4 ranks */
#define LL_ADC_REG_SEQ_DISCONT_5RANKS                                                                                  \
    (ADC_CR1_DISCNUM_2 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence      \
                                            interruption every 5 ranks */
#define LL_ADC_REG_SEQ_DISCONT_6RANKS                                                                                  \
    (ADC_CR1_DISCNUM_2 | ADC_CR1_DISCNUM_0 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode       \
                                                                enable with sequence interruption every 6 ranks */
#define LL_ADC_REG_SEQ_DISCONT_7RANKS                                                                                  \
    (ADC_CR1_DISCNUM_2 | ADC_CR1_DISCNUM_1 | ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode       \
                                                                enable with sequence interruption every 7 ranks */
#define LL_ADC_REG_SEQ_DISCONT_8RANKS                                                                                  \
    (ADC_CR1_DISCNUM_2 | ADC_CR1_DISCNUM_1 | ADC_CR1_DISCNUM_0 |                                                       \
     ADC_CR1_DISCEN) /*!< ADC group regular sequencer discontinuous mode enable with sequence interruption every 8     \
                        ranks */
/**
 * @}
 */
...
#define LL_ADC_REG_RANK_1                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_1_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 1 */
#define LL_ADC_REG_RANK_2                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_2_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 2 */
#define LL_ADC_REG_RANK_3                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_3_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 3 */
#define LL_ADC_REG_RANK_4                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_4_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 4 */
#define LL_ADC_REG_RANK_5                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_5_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 5 */
#define LL_ADC_REG_RANK_6                                                                                              \
    (ADC_SQR3_REGOFFSET | ADC_REG_RANK_6_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 6 */
#define LL_ADC_REG_RANK_7                                                                                              \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_7_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 7 */
#define LL_ADC_REG_RANK_8                                                                                              \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_8_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 8 */
#define LL_ADC_REG_RANK_9                                                                                              \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_9_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 9 */
#define LL_ADC_REG_RANK_10                                                                                             \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_10_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 10 */
#define LL_ADC_REG_RANK_11                                                                                             \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_11_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 11 */
#define LL_ADC_REG_RANK_12                                                                                             \
    (ADC_SQR2_REGOFFSET | ADC_REG_RANK_12_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 12 */
#define LL_ADC_REG_RANK_13                                                                                             \
    (ADC_SQR1_REGOFFSET | ADC_REG_RANK_13_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 13 */
#define LL_ADC_REG_RANK_14                                                                                             \
    (ADC_SQR1_REGOFFSET | ADC_REG_RANK_14_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 14 */
#define LL_ADC_REG_RANK_15                                                                                             \
    (ADC_SQR1_REGOFFSET | ADC_REG_RANK_15_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 15 */
#define LL_ADC_REG_RANK_16                                                                                             \
    (ADC_SQR1_REGOFFSET | ADC_REG_RANK_16_SQRX_BITOFFSET_POS) /*!< ADC group regular sequencer rank 16 */
/**
 * @}
 */
 ...
 * @{
 */
/* ADC group injected external triggers for ADC instances: ADC1, ADC2, ADC3 (for ADC instances ADCx available on the
 * selected device) */
#define LL_ADC_INJ_TRIG_SOFTWARE                                                                                       \
    (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1 |                                                                           \
     ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger internal: SW start. */
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                                                                  \
    0x00000000U /*!< ADC group injected conversion trigger from external IP: TIM1 TRGO. Trigger edge set to rising     \
                   edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                                                                   \
    (ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM1 channel 4 event (capture     \
                           compare: input capture or output capture). Trigger edge set to rising edge (default         \
                           setting). */
/* ADC group injected external triggers for ADC instances: ADC1, ADC2 (for ADC instances ADCx available on the selected
 * device) */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO                                                                                  \
    (ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger from external IP: TIM2 TRGO. Trigger edge set to    \
                           rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                                                   \
    (ADC_CR2_JEXTSEL_1 | ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM2 channel  \
                                               1 event (capture compare: input capture or output capture). Trigger     \
                                               edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4                                                                                   \
    (ADC_CR2_JEXTSEL_2) /*!< ADC group injected conversion trigger from external IP: TIM3 channel 4 event (capture     \
                           compare: input capture or output capture). Trigger edge set to rising edge (default         \
                           setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                                                                  \
    (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM4 TRGO.    \
                                               Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                                                \
    (ADC_CR2_JEXTSEL_2 |                                                                                               \
     ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger from external IP: external interrupt line 15.       \
                           Trigger edge set to rising edge (default setting). */
#if defined(STM32F101xE) || defined(STM32F103xE) || defined(STM32F103xG) || defined(STM32F105xC) || defined(STM32F107xC)
...
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                                                   \
    (LL_ADC_INJ_TRIG_EXT_EXTI_LINE15) /*!< ADC group injected conversion trigger from external IP: TIM8 channel 4      \
                                         event (capture compare: input capture or output capture). Trigger edge set to \
                                         rising edge (default setting). Available only on high-density and XL-density  \
                                         devices. A remap of trigger must be done at top level (refer to AFIO          \
                                         peripheral). */
#endif                                /* STM32F101xE || STM32F103xE || STM32F103xG || STM32F105xC || STM32F107xC */
#if defined(STM32F103xE) || defined(STM32F103xG)
/* ADC group injected external triggers for ADC instances: ADC3 (for ADC instances ADCx available on the selected
 * device) */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH3                                                                                   \
    (LL_ADC_INJ_TRIG_EXT_TIM2_TRGO) /*!< ADC group injected conversion trigger from external IP: TIM4 channel 3 event  \
                                       (capture compare: input capture or output capture). Trigger edge set to rising  \
                                       edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH2                                                                                   \
    (LL_ADC_INJ_TRIG_EXT_TIM2_CH1) /*!< ADC group injected conversion trigger from external IP: TIM8 channel 2 event   \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4_ADC3                                                                              \
    (LL_ADC_INJ_TRIG_EXT_TIM3_CH4) /*!< ADC group injected conversion trigger from external IP: TIM8 channel 4 event   \
                                      (capture compare: input capture or output capture). Trigger edge set to rising   \
                                      edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM5_TRGO                                                                                  \
    (LL_ADC_INJ_TRIG_EXT_TIM4_TRGO) /*!< ADC group injected conversion trigger from external IP: TIM5 TRGO. Trigger    \
                                       edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM5_CH4                                                                                   \
    (LL_ADC_INJ_TRIG_EXT_EXTI_LINE15) /*!< ADC group injected conversion trigger from external IP: TIM5 channel 4      \
                                         event (capture compare: input capture or output capture). Trigger edge set to \
                                         rising edge (default setting). */
#endif
/**
...
#define LL_ADC_INJ_TRIG_EXT_RISING                                                                                     \
    ADC_CR2_JEXTTRIG /*!< ADC group injected conversion trigger polarity set to rising edge */
/**
 * @}
 */
...
#define LL_ADC_INJ_TRIG_INDEPENDENT                                                                                    \
    0x00000000U /*!< ADC group injected conversion trigger independent. Setting mandatory if ADC group injected        \
                   injected trigger source is set to an external trigger. */
#define LL_ADC_INJ_TRIG_FROM_GRP_REGULAR                                                                               \
    (ADC_CR1_JAUTO) /*!< ADC group injected conversion trigger from ADC group regular. Setting compliant only with     \
                       group injected trigger source set to SW start, without any further action on  ADC group         \
                       injected conversion start or stop: in this case, ADC group injected is controlled only from ADC \
                       group regular. */
/**
 * @}
 */
...
#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                                                    \
    0x00000000U /*!< ADC group injected sequencer disable (equivalent to sequencer of 1 rank: ADC conversion on only 1 \
                   channel) */
#define LL_ADC_INJ_SEQ_SCAN_ENABLE_2RANKS                                                                              \
    (ADC_JSQR_JL_0) /*!< ADC group injected sequencer enable with 2 ranks in the sequence */
#define LL_ADC_INJ_SEQ_SCAN_ENABLE_3RANKS                                                                              \
    (ADC_JSQR_JL_1) /*!< ADC group injected sequencer enable with 3 ranks in the sequence */
#define LL_ADC_INJ_SEQ_SCAN_ENABLE_4RANKS                                                                              \
    (ADC_JSQR_JL_1 | ADC_JSQR_JL_0) /*!< ADC group injected sequencer enable with 4 ranks in the sequence */
/**
 * @}
 */
...
#define LL_ADC_INJ_SEQ_DISCONT_1RANK                                                                                   \
    (ADC_CR1_JDISCEN) /*!< ADC group injected sequencer discontinuous mode enable with sequence interruption every     \
                         rank */
/**
 * @}
 */
...
#define LL_ADC_INJ_RANK_1                                                                                              \
    (ADC_JDR1_REGOFFSET | ADC_JOFR1_REGOFFSET | 0x00000001U) /*!< ADC group injected sequencer rank 1 */
#define LL_ADC_INJ_RANK_2                                                                                              \
    (ADC_JDR2_REGOFFSET | ADC_JOFR2_REGOFFSET | 0x00000002U) /*!< ADC group injected sequencer rank 2 */
#define LL_ADC_INJ_RANK_3                                                                                              \
    (ADC_JDR3_REGOFFSET | ADC_JOFR3_REGOFFSET | 0x00000003U) /*!< ADC group injected sequencer rank 3 */
#define LL_ADC_INJ_RANK_4                                                                                              \
    (ADC_JDR4_REGOFFSET | ADC_JOFR4_REGOFFSET | 0x00000004U) /*!< ADC group injected sequencer rank 4 */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_INJ                                                                                    \
    (ADC_CR1_JAWDEN) /*!< ADC analog watchdog monitoring of all channels, converted by group injected only */
#define LL_ADC_AWD_ALL_CHANNELS_REG_INJ                                                                                \
    (ADC_CR1_JAWDEN | ADC_CR1_AWDEN) /*!< ADC analog watchdog monitoring of all channels, converted by either group    \
                                        regular or injected */
#define LL_ADC_AWD_CHANNEL_0_REG                                                                                       \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN0, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_0_INJ                                                                                       \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN0, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_0_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN0, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_1_REG                                                                                       \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN1, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_1_INJ                                                                                       \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN1, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_1_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN1, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_2_REG                                                                                       \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN2, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_2_INJ                                                                                       \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN2, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_2_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN2, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_3_REG                                                                                       \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN3, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_3_INJ                                                                                       \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN3, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_3_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN3, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_4_REG                                                                                       \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN4, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_4_INJ                                                                                       \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN4, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_4_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN4, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_5_REG                                                                                       \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN5, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_5_INJ                                                                                       \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN5, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_5_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN5, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_6_REG                                                                                       \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN6, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_6_INJ                                                                                       \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN6, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_6_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN6, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_7_REG                                                                                       \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN7, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_7_INJ                                                                                       \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN7, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_7_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN7, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_8_REG                                                                                       \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN8, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_8_INJ                                                                                       \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN8, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_8_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN8, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_9_REG                                                                                       \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                        \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN9, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_9_INJ                                                                                       \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN9, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_9_REG_INJ                                                                                   \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN9, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_10_REG                                                                                      \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN10, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_10_INJ                                                                                      \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN10, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_10_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN10, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_11_REG                                                                                      \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN11, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_11_INJ                                                                                      \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN11, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_11_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN11, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_12_REG                                                                                      \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN12, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_12_INJ                                                                                      \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN12, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_12_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN12, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_13_REG                                                                                      \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN13, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_13_INJ                                                                                      \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN13, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_13_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN13, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_14_REG                                                                                      \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN14, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_14_INJ                                                                                      \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN14, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_14_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN14, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_15_REG                                                                                      \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN15, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_15_INJ                                                                                      \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN15, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_15_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN15, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_16_REG                                                                                      \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN16, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_16_INJ                                                                                      \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN16, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_16_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN16, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_17_REG                                                                                      \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                       \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN17, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_17_INJ                                                                                      \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN17, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_17_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                      \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC external channel (channel connected to GPIO pin)       \
                        ADCx_IN17, converted by either group regular or injected */
#define LL_ADC_AWD_CH_VREFINT_REG                                                                                      \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                                  \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to VrefInt: Internal        \
                        voltage reference, converted by group regular only */
#define LL_ADC_AWD_CH_VREFINT_INJ                                                                                      \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                                 \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to VrefInt: Internal        \
                        voltage reference, converted by group injected only */
#define LL_ADC_AWD_CH_VREFINT_REG_INJ                                                                                  \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                                 \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to VrefInt: Internal        \
                        voltage reference, converted by either group regular or injected */
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                                                   \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN |                                               \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Temperature sensor,      \
                        converted by group regular only */
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                                                                   \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN |                                              \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Temperature sensor,      \
                        converted by group injected only */
#define LL_ADC_AWD_CH_TEMPSENSOR_REG_INJ                                                                               \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CR1_JAWDEN | ADC_CR1_AWDEN |                              \
     ADC_CR1_AWDSGL) /*!< ADC analog watchdog monitoring of ADC internal channel connected to Temperature sensor,      \
...
#define LL_ADC_MULTI_DUAL_REG_SIMULT                                                                                   \
    (ADC_CR1_DUALMOD_2 | ADC_CR1_DUALMOD_1) /*!< ADC dual mode enabled: group regular simultaneous */
#define LL_ADC_MULTI_DUAL_REG_INTERL_FAST                                                                              \
    (ADC_CR1_DUALMOD_2 | ADC_CR1_DUALMOD_1 |                                                                           \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular interleaved fast (delay between ADC         \
                           sampling phases: 7 ADC clock cycles) (equivalent to multimode sampling delay set to         \
                           "LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES" on other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_REG_INTERL_SLOW                                                                              \
    (ADC_CR1_DUALMOD_3) /*!< ADC dual mode enabled: Combined group regular interleaved slow (delay between ADC         \
                           sampling phases: 14 ADC clock cycles) (equivalent to multimode sampling delay set to        \
                           "LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES" on other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_INJ_SIMULT                                                                                   \
    (ADC_CR1_DUALMOD_2 |                                                                                               \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: group injected simultaneous slow (delay between ADC sampling       \
                           phases: 14 ADC clock cycles) (equivalent to multimode sampling delay set to                 \
                           "LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES" on other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_INJ_ALTERN                                                                                   \
    (ADC_CR1_DUALMOD_3 | ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: group injected alternate trigger. Works only   \
                                               with external triggers (not internal SW start) */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_SIM                                                                              \
    (ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected simultaneous  \
                         */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT                                                                              \
    (ADC_CR1_DUALMOD_1) /*!< ADC dual mode enabled: Combined group regular simultaneous + group injected alternate     \
                           trigger */
#define LL_ADC_MULTI_DUAL_REG_INTFAST_INJ_SIM                                                                          \
    (ADC_CR1_DUALMOD_1 |                                                                                               \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular interleaved fast (delay between ADC         \
                           sampling phases: 7 ADC clock cycles) + group injected simultaneous */
#define LL_ADC_MULTI_DUAL_REG_INTSLOW_INJ_SIM                                                                          \
    (ADC_CR1_DUALMOD_2) /*!< ADC dual mode enabled: Combined group regular interleaved slow (delay between ADC         \
                           sampling phases: 14 ADC clock cycles) + group injected simultaneous */
...
#define LL_ADC_MULTI_MASTER_SLAVE                                                                                      \
    (ADC_DR_ADC2DATA |                                                                                                 \
     ADC_DR_DATA) /*!< In multimode, selection among several ADC instances: both ADC master and ADC slave */
/**
 * @}
 */
...
/*       ratio of CPU clock versus ADC clock prescalers.                      */
/* Unit: ADC clock cycles.                                                    */
#define LL_ADC_DELAY_ENABLE_CALIB_ADC_CYCLES                                                                           \
    (2U) /*!< Delay required between end of ADC enable and the start of ADC calibration */
 ...
 *
 *         (1) On STM32F1, parameter available only on ADC instance: ADC1.
 * @retval Value "0" if the channel corresponds to a parameter definition of a ADC external channel (channel connected
 * to a GPIO pin). Value "1" if the channel corresponds to a parameter definition of a ADC internal channel.
 */
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                          \
    (((__ADC_INSTANCE__) == ADC1)                                                                                      \
         ? (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR))                 \
         : (0U))
...
#define __LL_ADC_ANALOGWD_CHANNEL_GROUP(__CHANNEL__, __GROUP__)                                                        \
    (((__GROUP__) == LL_ADC_GROUP_REGULAR) ? (((__CHANNEL__)&ADC_CHANNEL_ID_MASK) | ADC_CR1_AWDEN | ADC_CR1_AWDSGL)    \
 ...
 */
#if defined(ADC1) && defined(ADC2) && defined(ADC3)
#define __LL_ADC_COMMON_INSTANCE(__ADCx__) ((((__ADCx__) == ADC1) || ((__ADCx__) == ADC2)) ? ((ADC12_COMMON)) : ((0U)))
...
#elif defined(ADC1) && defined(ADC2)
#define __LL_ADC_IS_ENABLED_ALL_COMMON_INSTANCE(__ADCXY_COMMON__) (LL_ADC_IsEnabled(ADC1) | LL_ADC_IsEnabled(ADC2))
#else
 ...
 * @param  __TEMPSENSOR_TYP_AVGSLOPE__   Device datasheet data: Temperature sensor slope typical value (unit:
 * uV/DegCelsius). On STM32F1, refer to device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature sensor voltage typical value (at temperature
 * and Vref+ defined in parameters below) (unit: mV). On STM32F1, refer to device datasheet parameter "V25".
 ...
 */
#define __LL_ADC_CALC_TEMPERATURE_TYP_PARAMS(__TEMPSENSOR_TYP_AVGSLOPE__, __TEMPSENSOR_TYP_CALX_V__,                   \
...
/** @defgroup ADC_LL_EF_Configuration_ADC_Common Configuration of ADC hierarchical scope: common to several ADC
 * instances
 * @{
 */
 ...
 *
 *         (1) On STM32F1, parameter available on all ADC instances: ADC1, ADC2, ADC3 (for ADC instances ADCx available
 * on the selected device).\n (2) On STM32F1, parameter available only on ADC instances: ADC1, ADC2 (for ADC instances
 * ADCx available on the selected device).\n (3) On STM32F1, parameter available only on ADC instances: ADC3 (for ADC
 * instances ADCx available on the selected device).\n (4) On STM32F1, parameter available only on high-density and
 * XL-density devices. A remap of trigger must be done at top level (refer to AFIO peripheral).
 * @retval None
 */
...
__STATIC_INLINE void LL_ADC_REG_SetSequencerRanks(ADC_TypeDef *ADCx, uint32_t Rank, uint32_t Channel) {
    ...
    MODIFY_REG(*preg, ADC_CHANNEL_ID_NUMBER_MASK << (Rank & ADC_REG_RANK_ID_SQRX_MASK),
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerRanks(ADC_TypeDef *ADCx, uint32_t Rank) {
    ...
    return (uint32_t)(READ_BIT(*preg, ADC_CHANNEL_ID_NUMBER_MASK << (Rank & ADC_REG_RANK_ID_SQRX_MASK)) >>
...
__STATIC_INLINE void LL_ADC_INJ_SetSequencerRanks(ADC_TypeDef *ADCx, uint32_t Rank, uint32_t Channel) {
    ...
    MODIFY_REG(ADCx->JSQR, ADC_CHANNEL_ID_NUMBER_MASK << (5U * (uint8_t)(((Rank) + 3U) - (tmpreg1))),
...
__STATIC_INLINE uint32_t LL_ADC_INJ_GetSequencerRanks(ADC_TypeDef *ADCx, uint32_t Rank) {
    ...
    return (uint32_t)(READ_BIT(ADCx->JSQR, ADC_CHANNEL_ID_NUMBER_MASK << (5U * (uint8_t)(((Rank) + 3U) - (tmpreg1)))) >>
...
__STATIC_INLINE void LL_ADC_SetChannelSamplingTime(ADC_TypeDef *ADCx, uint32_t Channel, uint32_t SamplingTime) {
    ...
    /* other bits reserved for other purpose.                                   */
    __IO uint32_t *preg =
        __ADC_PTR_REG_OFFSET(ADCx->SMPR1, __ADC_MASK_SHIFT(Channel, ADC_CHANNEL_SMPRX_REGOFFSET_MASK));

    MODIFY_REG(*preg, ADC_SMPR2_SMP0 << __ADC_MASK_SHIFT(Channel, ADC_CHANNEL_SMPx_BITOFFSET_MASK),
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(ADC_TypeDef *ADCx, uint32_t Channel) {
    ...
    return (uint32_t)(READ_BIT(*preg, ADC_SMPR2_SMP0 << __ADC_MASK_SHIFT(Channel, ADC_CHANNEL_SMPx_BITOFFSET_MASK)) >>
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_Enable(ADC_TypeDef *ADCx) { SET_BIT(ADCx->CR2, ADC_CR2_ADON); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_Disable(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->CR2, ADC_CR2_ADON); }
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_ADC_StartCalibration(ADC_TypeDef *ADCx) { SET_BIT(ADCx->CR2, ADC_CR2_CAL); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_REG_StopConversionExtTrig(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->CR2, ADC_CR2_EXTTRIG); }
...
__STATIC_INLINE uint32_t LL_ADC_REG_ReadMultiConversionData32(ADC_TypeDef *ADCx, uint32_t ConversionData) {
    return (uint32_t)(READ_BIT(ADCx->DR, ADC_DR_ADC2DATA) >> POSITION_VAL(ConversionData));
}
#endif /* ADC_MULTIMODE_SUPPORT */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_INJ_StopConversionExtTrig(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->CR2, ADC_CR2_JEXTTRIG); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_ClearFlag_AWD1(ADC_TypeDef *ADCx) { WRITE_REG(ADCx->SR, ~LL_ADC_FLAG_AWD1); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_EnableIT_AWD1(ADC_TypeDef *ADCx) { SET_BIT(ADCx->CR1, LL_ADC_IT_AWD1); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_DisableIT_AWD1(ADC_TypeDef *ADCx) { CLEAR_BIT(ADCx->CR1, LL_ADC_IT_AWD1); }
